...
\node[xshift=1.17cm,yshift=1.2cm] at (-1.75,-2.75) (x) {};
...
%\draw[black,-latex] (-1.75,-2.75) -- ++ (0,-.9); 
\draw[black,-latex,xshift=1.17cm,yshift=1.2cm] (-1.75,-2.75) -- ++ (0,-.9)  node[below,inner sep=0]{\scriptsize $\nabla f(\bar{x})$};
