...
\begin{examplewithcode}{Min Coins}{https://github.com/open-optimization/open-optimization-or-examples/blob/master/integer-programming/coins-minimize-problem.ipynb}
\label{ex:min-coins}
...
\begin{examplewithcode}{School Bus Routing Problem}{https://github.com/open-optimization/open-optimization-or-examples/blob/master/integer-programming/School-bus-assignment.ipynb}
...
\includegraphics[scale = 0.07]{optimization/figures/figures-static/jssp-duplo-actual}
