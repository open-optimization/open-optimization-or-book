...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{Figures/risk-plot.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/pareto-curve.png}
...
%
%  \end{axis}
%\end{tikzpicture}%\includegraphics[width=0.5\textwidth]{optimization/multi-objective/images/2022_02_28_634e8079070800ac7e3cg-10}
