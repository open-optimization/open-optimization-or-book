...
\chapter{Duality}
% Provenance note (2026-07-16): an earlier version of this chapter carried a
% "borrowed section" warning. The chapter has since been rewritten (bakery
% motivating example and all derivations are original to this book); shingle
% comparison against the previously referenced external notes shows no
% substantive overlap. The old verbatim excerpt lived in
% archive/orphaned-content/borrowed-duality.tex and was deleted 2026-07-16
% (source license CC BY-NC-SA, incompatible with this book's CC BY-SA 4.0).
\begin{outcome}
You will learn
\begin{itemize}
