...
%\end{center}
\begin{center}
\includegraphics[scale = 0.8]{Figures/tree-diagram-types}
\end{center}
...
Quadratic programming (free) & OSQP, CLP, DAQP (mixed-binary), OOQP, QPC, QPOASES, QUADPROGBB (nonconvex QP) \\
...
Semidefinite programming (free) & CSDP, DSDP, LOGDETPPA, PENLAB, SCS, SDPA, SDPLR, SDPT3, SDPNAL, SEDUMI \\
...
\label{tab:optimization_software}
\end{table}
