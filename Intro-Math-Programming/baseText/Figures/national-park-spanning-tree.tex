...
\draw[<->, red, thick] (CG) -- (VC) node[midway, above left] {5};
\draw[<->] (CG) -- (WF) node[midway, above] {8};
\draw[<->, red, thick] (CG) -- (SE) node[midway, above] {10};
\draw[<->, red, thick] (NE) -- (WF) node[midway, above left] {6};
\draw[<->, red, thick] (WF) -- (FCP) node[midway, above] {5};
\draw[<->] (WF) -- (CL) node[midway, above] {5};
\draw[<->] (FCP) -- (CL) node[midway, right] {8};
\draw[<->, red, thick] (FCP) -- (TM) node[midway, above] {6};
\draw[<->] (VC) -- (BM) node[midway, below left] {30};
\draw[<->, red, thick] (VC) -- (FCP) node[midway, below] {5};
...
\draw[<->, red, thick] (BM) -- (GF) node[midway, below right] {15};
