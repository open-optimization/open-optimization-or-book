\section{Installing and Managing Python}{Installing and Managing Python}
\label{pythoninstall}
...
\begin{warn}
This curriculum uses Python 3.6 (or most updated version), \textbf{not} Python 2.7.
...
To begin using Jupyter Notebook, run the command \li{jupyter notebook} in the terminal or open it from the user interface provided by Anaconda.
