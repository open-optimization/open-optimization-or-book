    ...
    % ucs is incompatible with biblatex ("Incompatible package 'ucs'" at
    % \begin{document}).  Only load it when biblatex is absent; biblatex
    % defines \addbibresource immediately at load time, so test that.
    \ifx\addbibresource\undefined
