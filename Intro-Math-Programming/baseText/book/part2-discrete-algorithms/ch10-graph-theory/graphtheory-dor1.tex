...
\node[aboveLabel, above=2pt of T] {#6};
...
\draw (MR) -- (P) node[midway, left, edgeLabel] {27};
\draw (MR) -- (Y) node[midway, above, edgeLabel] {96};
...
\node at (0,0.9){\$11};
\node at (3.4,0.85){\$14};
\end{tikzpicture}\par\captionof{figure}{Weighted graph of leasing costs, in thousands of dollars per year, between the five offices A, B, C, D, E.}\label{fig:graphtheory-dor1-tikz23}% fig-num-auto
...
\draw(0,0)--(1,1);
\draw(1,2)--(2,0);
\end{tikzpicture}\par\captionof{figure}{A spanning tree on four vertices with three edges.}\label{fig:graphtheory-dor1-tikz24}% fig-num-auto
...
\draw(2,0)--(1,1);
\draw(1,2)--(2,0);
\end{tikzpicture}\par\captionof{figure}{Another spanning tree on the same four vertices.}\label{fig:graphtheory-dor1-tikz25}% fig-num-auto
...
\draw(6,2)--(6,-2);
\node at (6.3,0){2};
\end{tikzpicture}\par\captionof{figure}{Weighted graph with seven vertices A through G for the shortest path exercise.}\label{fig:graphtheory-dor1-tikz39}% fig-num-auto
...
\draw(1,1)--(2,1);
\draw(2,1)--(1,0);
\end{tikzpicture}\par\captionof{figure}{Five-vertex graph for the degree exercise.}\label{fig:graphtheory-dor1-tikz40}% fig-num-auto
...
\draw(-1,1)--(-0.5,2);
\draw(1,1)--(0.5,2);
\end{tikzpicture}\par\captionof{figure}{Another five-vertex graph for the degree exercise.}\label{fig:graphtheory-dor1-tikz41}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Virginia passenger rail network with travel times in minutes.}\label{fig:graphtheory-dor1-tikz50}% fig-num-auto
