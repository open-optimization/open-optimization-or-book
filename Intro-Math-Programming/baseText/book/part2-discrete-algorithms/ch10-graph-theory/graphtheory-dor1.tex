...
\altincludegraphics{graph-theory-graphics/GraphExercise15.png}{Exercise map of an amusement park's walkways drawn as a planar graph: curved edges partition the irregular region into roughly a dozen face-like sections that the maintenance crew must patrol via an Euler circuit.}\\
