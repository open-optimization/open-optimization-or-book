...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the line y = 3x + 2 on x-y axes with a gridded background.}\label{fig:equations-and-lines-new-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the line 2x + y = 4 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{A line through the intercepts (0,-2) and (3,0).}\label{fig:equations-and-lines-new-tikz03}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{A line through the points (3,1), (5,2), and (7,3).}\label{fig:equations-and-lines-new-tikz04}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the horizontal line y = 3 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz05}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the vertical line x = -2 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz06}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot illustrating the slope of the line through (-2,3) and (4,-1) on x-y axes.}\label{fig:equations-and-lines-new-tikz07}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the line through (1,2) with slope -3/4 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz08}% fig-num-auto
...
\begin{tikzpicture}[xscale=0.6, yscale=0.2]
    ...
    \draw[very thick,->] (-2,0) -- (12,0) node[right] {Price ($x$)};
    \draw[very thick,->] (0,-2) -- (0,20) node[above] {Quantity ($y$)};
    ...
    \node[anchor=north] at (8,0) {8 (Price)};
    \node[anchor=east] at (0,14) {14 (Quantity)};
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of an equilibrium point.}\label{fig:equations-and-lines-new-tikz09}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of a break-even point.}\label{fig:equations-and-lines-new-tikz10}% fig-num-auto
