...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the xy-plane showing two points P = (2,1) and Q = (-3,4) marked as red...}\label{fig:RnVectorsRn-tikz01}% fig-num-auto
...
p_1 & p_2 & p_3 
\end{array}\rightB^T$};
\end{tikzpicture}\par\captionof{figure}{Three-dimensional diagram of the position vector 0P: a thick blue arrow from the origin along the...}\label{fig:RnVectorsRn-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Three-dimensional diagram with two parallel blue arrows of equal length and direction: the position...}\label{fig:RnVectorsRn-tikz03}% fig-num-auto
