...
\begin{example}{Basic and Free Variables}\label{exa:basicfree}
...
\begin{proposition}{Basic and Free Variables}\label{prop:basicfree}
...
\begin{lemma}{Solutions and the \RREF \;of a Matrix}\label{lem:rrefsolutions}
...
\begin{theorem}{Equivalent Matrices}\label{thm:equivalent}
...
\begin{theorem}{Uniqueness of the \RREF}\label{thm:uniquerref}
