...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional sketch of two vectors emanating from a common origin: a blue vector v pointing up...}\label{fig:RnVectorsDotProductSignificance-tikz01}% fig-num-auto
