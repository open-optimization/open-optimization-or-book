...
\begin{example}{Addition of Matrices of Same Size}\label{exa:samesizematrixaddition}
...
\begin{proposition}{Properties of Matrix Addition}\label{prop:propertiesofaddition}
