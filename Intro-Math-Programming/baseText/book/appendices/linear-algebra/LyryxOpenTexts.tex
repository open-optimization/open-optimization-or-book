...
\vspace{-3em}
\begin{center}
	\altincludegraphics[width=.4\textwidth]{figures/LyryxLogo.eps}{Lyryx Learning logo: stylized wordmark 'Lyryx' in dark grey with a small accent above the 'y'.}\footnote{This book was not produced by Lyryx, but this book has made substantial use of their open source material.  We leave this page in here as a tribute to Lyryx for sharing their content.}
...
\vspace{0pt}
\altincludegraphics[scale=0.15]{figures/component-book.eps}{Lyryx 'Open Text' component icon: a stylized open book.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{figures/component-assess.eps}{Lyryx 'Online Assessment' component icon: a checklist or graded form glyph.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{figures/component-support.eps}{Lyryx 'Support' component icon: a headset glyph representing customer support.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{figures/component-supplement.eps}{Lyryx 'Instructor Supplements' component icon: stacked documents or resource pages glyph.}
&
\vspace{0pt}
