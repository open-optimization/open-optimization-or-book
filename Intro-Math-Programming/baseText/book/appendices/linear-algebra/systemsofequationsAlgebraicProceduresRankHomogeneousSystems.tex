...
\begin{definition}{Trivial Solution}\label{def:trivialsolution}
...
\begin{example}{Solutions to a Homogeneous System of Equations}\label{exa:homogeneoussolution}
...
\begin{example}{Basic Solutions of a Homogeneous System}\label{exa:basicsolutions}
...
\begin{definition}{Linear Combination}\label{def:linearcombination-columns}
...
\begin{example}{Finding the Rank of a Matrix}\label{exa:rankofamatrix}
\label{example:rankofamatrix}
Consider the matrix
\begin{equation*}
\leftB
\begin{array}{rrr}
...
\begin{theorem}{Rank and Solutions to a Homogeneous System}\label{thm:rankhomogeneoussolutions}
...
\begin{theorem}{Rank and Solutions to a Consistent System of Equations}\label{thm:rankconsistentsolutions}
