...
\begin{example}{Matrix Multiplication is Not Commutative}\label{exa:noncommutativemultiplication}
...
\begin{proposition}{Properties of Matrix Multiplication}\label{prop:propertiesofmatrixmultiplication}
