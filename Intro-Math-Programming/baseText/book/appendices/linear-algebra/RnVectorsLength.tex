...
\put(55,33){$P=(p_1,p_2)$}
\end{picture}}
\end{picture}\par\captionof{figure}{The distance between two points in the plane.}\label{fig:distance-2d}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{The distance between two points in three dimensions.}\label{fig:distance-3d}% fig-num-auto
...
\begin{definition}{Distance Between Points}\label{def:distancebetweenpoints}
...
\begin{example}{Distance Between Points}\label{exa:distancebetweenpoints}
...
\begin{theorem}{Properties of Distance}\label{thm:distanceproperties}
...
\begin{example}{The Plane Between Two Points}\label{exa:planebetweentwopoints}
...
\begin{definition}{Length of a Vector}\label{def:lengthofvector}
...
\begin{definition}{Unit Vector}\label{def:unitvector}
...
\begin{example}{Finding a Unit Vector}\label{exa:unitvector}
