...
\end{tikzpicture}\par\captionof{figure}{Three side-by-side 2D plots showing how two lines can intersect: 'One Solution' (crossing at a...}\label{fig:systemsofequationsGeometry-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of the system x+y=3 and y-x=5: a green line and a blue line crossing at the...}\label{fig:systemsofequationsGeometry-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two side-by-side two-dimensional plots showing three lines in the plane: on the left, three lines...}\label{fig:systemsofequationsGeometry-tikz03}% fig-num-auto
