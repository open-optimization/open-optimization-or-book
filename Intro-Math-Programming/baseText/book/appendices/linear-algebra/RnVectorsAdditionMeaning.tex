...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional vector diagram illustrating the tip-to-tail rule for vector addition: arrow u along...}\label{fig:RnVectorsAdditionMeaning-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsAdditionMeaning-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional vector diagram of u+v drawn tip-to-tail: blue u from the origin to the upper right...}\label{fig:RnVectorsAdditionMeaning-tikz03}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional vector diagram of u-v: blue u from the origin, red -v starting at the tip of u and...}\label{fig:RnVectorsAdditionMeaning-tikz04}% fig-num-auto
