...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsScalarMultMeaning-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional diagram showing scalar multiples of two vectors: blue vector u and its negative -u...}\label{fig:RnVectorsScalarMultMeaning-tikz02}% fig-num-auto
...
\node[below] at (1,1.25){$\vect{u}$};
\node[above right] at (4.5, 0.75){$\vect{v}$};
\end{tikzpicture}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsScalarMultMeaning-tikz03}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional vector diagram of the linear combination u + 2v: blue vector u from the origin, red...}\label{fig:RnVectorsScalarMultMeaning-tikz04}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional vector diagram of the linear combination u - 1/2 v: blue u from the origin, the...}\label{fig:RnVectorsScalarMultMeaning-tikz05}% fig-num-auto
