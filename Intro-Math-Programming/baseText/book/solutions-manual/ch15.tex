...
\]
(b) Optimal load: packages 2, 3, 4, 5, with weight $3+2+5+4 = 14 \leq 15$ and payout $3+3+7+4 = \$17$. Taking the heavy package 1 leaves only 4\,kg for the rest, capping the payout at $5+4 = \$9$ (package 5 is the best that still fits). Matches the book's Selected Solution; verified with PuLP.
