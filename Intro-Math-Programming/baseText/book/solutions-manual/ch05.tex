...
\exsol{5.9}{Finite or Unbounded?}{2}
...
\begin{qaflag}
The problem is \emph{unbounded}: the direction $(0,1)$ is feasible and improving, so $\max\, (-2x_1 + x_2)$ has no finite optimum. (The exercise was retitled ``Finite or Unbounded?'' in 2026-08 so the title does not presuppose the answer.)
\end{qaflag}
