...
Perturb $b_1 = 10 + \Delta$. The slack of constraint 1 absorbs the change: setting $s_1' = s_1 - \Delta$ restores the original right-hand side, so the final dictionary is valid with $s_1'$ in place of $s_1$; substituting $s_1' = s_1 - \Delta$ expresses it in the original variables:
\[
\begin{aligned}
