...
\begin{figure}[h]
  ...
  \addplot[fill=blue!30, draw=blue, opacity = 0.3, thick] coordinates {
    ...
    % Exact corners of the >=70%-revenue region: 4x+y=33.6 meets y=0 at
    % (8.4,0) and meets 1.2x+y=20 at (34/7, 99.2/7) ~ (4.857,14.171).
...
$f_2$    & 9 & 7 & 8 & 3 & 5 \\
\end{tabular}
\par\captionof{table}{Cost and delivery time for the five supplier contracts.}\label{tab:multi-objective-optimization_updated-tab01}% tab-num-auto
...
$f_2$  & 5 & 8 & 4 & 6 & 6 & 3 \\
\end{tabular}
\par\captionof{table}{Cost and emissions for the six candidate designs.}\label{tab:multi-objective-optimization_updated-tab02}% tab-num-auto
...
P3 & 3 & 6 \\
\end{tabular}
\par\captionof{table}{Cost and accessibility score for each road improvement project.}\label{tab:multi-objective-optimization_updated-tab03}% tab-num-auto
...
S4 & 70 & 8 \\
\end{tabular}
\par\captionof{table}{Pareto optimal solutions found by the weighted-sum method.}\label{tab:multi-objective-optimization_updated-tab04}% tab-num-auto
...
18 & 0 & 6 & 6  & 18 \\
\end{tabular}
\par\captionof{table}{Solutions of the $\varepsilon$-constraint problem as $\varepsilon$ varies.}\label{tab:multi-objective-optimization_updated-tab05}% tab-num-auto
