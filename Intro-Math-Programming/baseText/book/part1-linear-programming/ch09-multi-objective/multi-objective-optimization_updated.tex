...
\begin{axis}[
  ...
  % Feasible region (blue fill)
  \addplot[fill=blue!30, draw=blue, opacity=0.3, thick] coordinates {
    (0,0) (0,20) (10,8) (12,0) (0,0)
  };

  % Constrained subset
  \addplot[fill=blue!70, draw=blue, opacity=0.3, thick] coordinates {
    (8.5,0) (5,14) (10,8) (12,0) (8.5,0)
  };

  % Constraint lines
  \addplot[domain=0:12, thick, blue] {48 - 4*x};
  \addplot[domain=0:12, thick, blue] {20 - 1.2*x};

  % Objective function iso-lines (waste objective)
  \foreach \z in {5,10,...,60}{
...
When drawing legislative districts, mapmakers balance several objectives: population equality across districts, geographic compactness, preservation of political boundaries (counties, cities), and fair representation of communities.  These objectives often conflict---for instance, improving compactness may split a county, while keeping counties intact may lead to less compact shapes.  Multi-objective optimization can generate the Pareto frontier of district plans, making the inherent trade-offs transparent to policymakers and the public.
