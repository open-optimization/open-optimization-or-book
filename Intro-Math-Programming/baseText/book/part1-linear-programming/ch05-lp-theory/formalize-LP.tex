...
\end{tikzpicture}\par\captionof{figure}{Feasible region with the lines s1=0, s2=0, s3=0 marking where each slack variable vanishes; basic...}\label{fig:formalize-LP-tikz12}% fig-num-auto
 \end{center} 
\end{minipage}
