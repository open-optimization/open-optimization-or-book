...
\end{tikzpicture}\par\captionof{figure}{A number line showing that the objective value at z lies between the objective values at x and y.}\label{fig:formalize-LP-tikz10}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Two-dimensional plot of a quadrilateral polytope with vertices (0,0), (1,2), (3,2), (4,0).}\label{fig:formalize-LP-tikz11}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Feasible region with the lines $s_1=0$, $s_2=0$, $s_3=0$ marking where each slack variable vanishes; the extreme points $(0,0)$, $(0,1)$, and $(2,3)$ are marked.}\label{fig:formalize-LP-tikz12}% fig-num-auto
 \end{center} 
\end{minipage}
