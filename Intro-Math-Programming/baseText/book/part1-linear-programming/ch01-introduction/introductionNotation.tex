...
%
% NOTE (2026-05-13): This file is NO LONGER included by book1-main.tex.
% The notation chapter is now sourced from frontmatter/notation.tex as an
% unnumbered front-matter chapter. Content here is retained for provenance
% and as a fallback. To revert, re-add \input of this file in book1-main.tex.
...
\item $\sum_{i=1}^4 i^2 = 1^2 + 2^2 + 3^2 + 4^2$
...
A sample sentence:
$$
\forall x \in \Q^n \setminus \{\mathbf{0}\} \ \exists y \in \Z^n\setminus \{\mathbf{0}\} \ \text{ s.t. } \ x^\top y \in \{0,1\}
$$
