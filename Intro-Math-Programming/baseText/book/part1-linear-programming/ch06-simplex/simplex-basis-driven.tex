...
We consider the example from Section~\ref{sec:pivoting}.  In that example, we pivoted first on the $y$ variable.  This choice of pivot called the \emph{steepest ascent} rule since we chose the variable in the objective with the largest coefficient.  
