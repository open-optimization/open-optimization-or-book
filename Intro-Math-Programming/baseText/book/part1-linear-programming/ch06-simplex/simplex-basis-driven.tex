...
\end{tikzpicture}\par\captionof{figure}{The feasible region with the basis and objective value at every vertex; the simplex path leads to...}\label{fig:simplex-basis-driven-tikz08}% fig-num-auto
