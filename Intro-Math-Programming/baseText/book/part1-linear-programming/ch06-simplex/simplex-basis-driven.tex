...
\end{tikzpicture}\par\captionof{figure}{When can you use canonical form?}\label{fig:simplex-basis-driven-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{The feasible region with the basis and objective value at every vertex; two possible simplex paths (solid and dashed) both lead to the optimal vertex $(4,5)$.}\label{fig:simplex-basis-driven-tikz08}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Feasible region after adding the constraint 2x+y>=5: the pink triangle near the origin becomes infeasible.}\label{fig:simplex-basis-driven-tikz10}% fig-num-auto
