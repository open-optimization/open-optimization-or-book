...
\end{aligned}
\]
We then swap the constraints with negative values for the basic variables ($s_1, s_3$) for our artificial variables.

\[
\begin{aligned}
\max\quad & -8000 + 3003x + 1002y - 1000s_1 - 1000s_3 \\
\st\quad 
& a_1 = 5 - 2x - y + s_1,\\ 
& s_2 = 16 - 3x - y,\\ 
& a_3 = 3 - x + s_3,\\ 
...
\[
\begin{aligned}
\max\quad & -492.50 - 499.50y + 501.50s_1 - 1000s_3 - 1501.50a_1 \\
\st\quad 
...
\[
\begin{aligned}
\max\quad & 9 + 2y + 3s_3 - 1000a_1 - 1003a_3 \\
\st\quad 
& x = 3 + s_3 - a_3,\\ 
& s_2 = 7 - y - 3s_3 + 3a_3,\\ 
