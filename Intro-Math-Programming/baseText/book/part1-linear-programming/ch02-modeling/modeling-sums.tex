...
\end{tikzpicture}\par\captionof{figure}{Schematic of a multi-period production network: gray circles labelled 1, 2, ..., T-1, T.}\label{fig:modeling-sums-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Bipartite assignment diagram: three people P1, P2, P3 drawn as stick-figure icons in blue circles...}\label{fig:modeling-sums-tikz02}% fig-num-auto
