...
\end{tikzpicture}\par\captionof{figure}{Schematic of a two-period production planning network: two gray circles labelled 1 and 2.}\label{fig:modeling-linear-programming-tikz01}% fig-num-auto
