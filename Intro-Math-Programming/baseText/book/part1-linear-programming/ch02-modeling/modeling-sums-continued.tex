...
\end{tikzpicture}\par\captionof{figure}{Undirected network with six numbered circular nodes: edges join 6-4, 4-5, 4-3, 5-1, 5-2, 3-2, and 2-1.}\label{fig:modeling-sums-continued-tikz01}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Directed version of the same six-node network: curved arrows show arc directions, including a...}\label{fig:modeling-sums-continued-tikz02}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Transshipment network: supply nodes W1 (+30) and W2 (+20) on the left, transshipment nodes D1 and...}\label{fig:modeling-sums-continued-tikz03}% fig-num-auto
...
\end{tikzpicture}\par\captionof{figure}{Directed network with eight nodes labeled a through h arranged left to right.}\label{fig:modeling-sums-continued-tikz04}% fig-num-auto
...
\begin{tikzpicture}[
   ...
   % Nodes with inventory labels
    ...
    \draw[->, thick] (W2) -- node[below] {70} (D2);\end{tikzpicture}\par\captionof{figure}{Disaster-relief transportation network: warehouse rectangles W1-W5 (inventories 200, 300, 150, 250...}\label{fig:modeling-sums-continued-tikz10}% fig-num-auto
...
\begin{center}
    ...
    \end{tikzpicture}\par\captionof{figure}{Directed max-flow exercise network: green source s and red sink t with intermediate nodes v1, v2, v3, v4.}\label{fig:modeling-sums-continued-tikz11}% fig-num-auto
...
%\node[\p] (\i) {\txt};
    ...
    \end{tikzpicture}\par\captionof{figure}{Six-node directed network for a min-cost flow exercise: nodes v1 through v6 with blue supply values...}\label{fig:modeling-sums-continued-tikz12}% fig-num-auto
