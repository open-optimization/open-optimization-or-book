...
\begin{ex}{Sketch Feasible Region}{ex:feasible-region}
...
\begin{ex}{Infeasible Region Graph}{ex:infeasible}
Graph the feasible region of the linear program:
\begin{align*}
\min  \quad & x_1 - x_2\\
 & x_1 + x_2 \leq 6\\
...
\begin{ex}{Determine Optimal Value}{ex:lp-optimal-value}
...
\begin{ex}{Show Unbounded Problem}{ex:lp-unbounded}
