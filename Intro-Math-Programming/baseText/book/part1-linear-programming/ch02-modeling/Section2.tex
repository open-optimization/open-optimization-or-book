...
We want to start by plotting the \emph{feasible region}, that is, the set of points $(x_1,x_2)$ that satisfy all the constraints.
...
Consider the feasible region from Example~\ref{ex:LPUnboundFeasibleRegion1} (with $x_1-x_2\leq 3$ and $x_1+2x_2\geq 4$). Does the problem $\max\; z = -2x_1 + x_2$ subject to these constraints have a finite solution? Justify your answer using the Complete Graphical Method.
