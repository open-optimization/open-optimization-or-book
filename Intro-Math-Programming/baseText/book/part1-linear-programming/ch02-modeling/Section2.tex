...
\end{tikzpicture}\par\captionof{figure}{Cone-shaped feasible region between the lines s1 = 0 and s3 = 0, with s2 = 0 above, shaded blue and marked...}\label{fig:Section2-tikz12}% fig-num-auto
 \end{center}
\end{minipage}
