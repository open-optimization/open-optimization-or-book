...
\end{tikzpicture}\par\captionof{figure}{Cone-shaped feasible region on x1-x2 axes: blue shading between the lines s1 = 0 (red, lower...}\label{fig:Section2-tikz11}% fig-num-auto
 \end{center}
\end{minipage}
...
\filldraw[fill=red] (-0.05,.95) rectangle (0.05,1.05);
\filldraw[fill=red] (1.95,2.95) rectangle (2.05,3.05);
\end{tikzpicture}\par\captionof{figure}{The same cone-shaped region between s1 = 0 and s3 = 0 with s2 = 0 above, shaded blue and marked...}\label{fig:Section2-tikz12}% fig-num-auto
 \end{center}
...
\end{tikzpicture}\par\captionof{figure}{Recession cone plot: shaded blue cone between the lines s1 = 0 (red) and s3 = 0 (orange) with s2 =...}\label{fig:Section2-tikz13}% fig-num-auto
 \end{center}
\end{minipage}
...
\draw [black] (0,1)  -- node[above right] {$x_1+x_2 = 1$} (1,0);
\end{tikzpicture}\par\captionof{figure}{The same recession cone between s1 = 0 and s3 = 0 with the line x1 + x2 = 1 crossing it, used to...}\label{fig:Section2-tikz14}% fig-num-auto
 \end{center}
...
\begin{center}  \begin{tikzpicture}[x=50mm, y=50mm]
...
\draw [black] (0,1)  -- node[above right] {$x_1+x_2 = 1$} (1,0);
\end{tikzpicture}\par\captionof{figure}{Zoomed view of the normalization segment: the line x1 + x2 = 1 crosses the shaded cone between s1 =...}\label{fig:Section2-tikz15}% fig-num-auto
 \end{center}
