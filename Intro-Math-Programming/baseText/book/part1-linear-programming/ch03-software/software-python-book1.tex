...
\bottomrule
\end{tabular}
\par\captionof{table}{Resource usage per unit and availability for the two products.}\label{tab:software-python-book1-tab01}% tab-num-auto
...
C & 6 & 7 & 5 \\
\end{tabular}
\par\captionof{table}{Unit shipping costs from plants to markets.}\label{tab:software-python-book1-tab02}% tab-num-auto
