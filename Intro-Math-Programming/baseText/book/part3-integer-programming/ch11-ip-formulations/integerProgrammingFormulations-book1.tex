...
\begin{figure}[h!]
\centering
\includegraphics[scale = 0.4]{optimization/figures/figures-static/new-york-tolls}
...
\includetikz[width=0.8\textwidth]{optimization/figures/figures-static/jssp}
...
\begin{center}
\includetikz[width = 0.8\textwidth]{optimization/figures/figures-static/jssp-duplo}\par\captionof{figure}{Gantt chart of the Duplo job shop scheduling solution with three machines and four color-coded jobs.}\label{fig:jssp-duplo}% fig-num-auto
