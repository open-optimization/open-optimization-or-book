...
\chapter{Solvers and Modeling Languages}
\label{ch:solvers}
\todoChapter{ Stub chapter: currently link lists. Needs real prose (solver
landscape, modeling-language comparison, worked examples) or folding into
ch13. See BOOK2-INVENTORY-2026-07-31.md priority list. }
