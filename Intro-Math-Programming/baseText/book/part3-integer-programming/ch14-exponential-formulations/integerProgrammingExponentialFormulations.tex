...
\begin{center}
% LICENSE-FLAG (2026-07-31): pipes.png is third-party clipart from pinclipart.com (see footnote URL); PinClipart terms are personal-use and the original author/license are unknown. Not CC-compatible as far as we can verify; replace or confirm provenance before distribution.
...
\end{example}
\begin{center}
% LICENSE-FLAG (2026-07-31): pipes.png is third-party clipart from pinclipart.com; author/license unknown (see flag at first use above).
...
\begin{figure}
% LICENSE-FLAG (2026-07-31): tsp-optimal-route.png is a screenshot of an Optimap (gebweb.net) route rendered on Google Maps (see caption). Google Maps imagery is not freely licensable; not CC-compatible. Replace with an OpenStreetMap-based rendering or confirm permission before distribution.
