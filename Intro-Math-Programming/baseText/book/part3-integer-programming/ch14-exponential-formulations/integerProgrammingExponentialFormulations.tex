...
\end{tikzpicture}
\par\captionof{figure}{Cutting stock: stock pipes of length $L$ are cut into shorter pieces according to a cut pattern, possibly leaving waste.}\label{fig:cutting-stock-pipes}% fig-num-auto
\end{center}
...
\begin{center}
\includegraphics[scale = 1]{Figures/knapsack-fig.pdf}\par\captionof{figure}{The pattern polytope P: each integer point in the blue triangle represents a feasible cut pattern.}\label{fig:knapsack-fig}% fig-num-auto
...
\begin{center}
\includegraphics[scale = 1]{Figures/knapsack-fig-opt.pdf}\par\captionof{figure}{Maximal cut patterns in the pattern polytope: only the highlighted integer points are needed.}\label{fig:knapsack-fig-opt}% fig-num-auto
...
Cuts of length 4m &0 &0 &1 &0 &2 &1 &2 &3 &4 & 1\\
 ...
 \hline
\end{tabular}
\par\captionof{table}{All possible cut patterns for the pipe cutting example.}\label{tab:integerProgrammingExponentialFormulations-tab01}% tab-num-auto
...
Cuts of length 4m &4 & 0 & 0  \\ %&1 &0 &2 &1 &2 &3 &4 & 1\\
 ...
 \hline
\end{tabular}
\par\captionof{table}{Initial choice of columns (patterns) for the column generation example.}\label{tab:integerProgrammingExponentialFormulations-tab02}% tab-num-auto
...
\hline
\end{tabular}
\par\captionof{table}{Distance matrix for the four-city TSP instance solved with the MTZ model.}\label{tab:integerProgrammingExponentialFormulations-tab03}% tab-num-auto
...
\hline
\end{tabular}
\par\captionof{table}{Distance matrix for the four-city TSP instance solved with the DFJ model.}\label{tab:integerProgrammingExponentialFormulations-tab04}% tab-num-auto
...
\par\captionof{figure}{The complete graph on four nodes: every pair of cities is joined by an edge.}\label{fig:dfj-complete-graph}% fig-num-auto
\end{center}
...
\includegraphicstatic{m-tsp_solution}\par\captionof{figure}{Solution of a multiple traveling salesman problem on a street map: colored routes assign customer sites to vehicles starting from a common depot.}\label{fig:m-tsp_solution}% fig-num-auto
