...
% Removed 2026-07-16: a five-panel 2-opt figure sequence (2-opt-1 ... 2-opt-5)
% was included here with the footnote "Figures borrowed from unknown source."
% The image files no longer exist in the repository, and unknown provenance is
% incompatible with the book's CC BY-SA 4.0 license. TODO (Book 2): recreate
% the step-by-step 2-opt swap sequence as original TikZ figures.
