...
$$
&
\includegraphics[scale = 0.3]{cutting-plane-2-picture}\\
$$
\begin{array}{lrl}
\max \ & x_1 + x_2\\
\text{subject to  } &  -2x_1 + x_2 &\leq 0.5\\
...
$$
&
\includegraphics[scale = 0.3]{cutting-plane-3-picture}\\
\hline
 \end{tabular}
\end{table}
...
\begin{enumerate}
\item How to make an integer version of the S-Lemma?
\item How to make an integer analog of Sums of Squares Programming?
\item How to derive cutting planes for mixed integer polynomial optimization problems?
\end{enumerate}
\newpage
