...
%This page titled 1.1: Graphing a Linear Equation is shared under a CC BY 4.0 license and was authored, remixed, and/or curated by Rupinder Sekhon and Roberta Bloom via source content that was edited to the style and standards of the LibreTexts platform.

\chapter{Linear Equations}
\todoChapter{{\color{gray}0\% complete. Goal: Update formatting to match CC-BY-SA 4.0 license and previous style.}}
\begin{outcome}
\begin{itemize}
...
\begin{example}{Graphing a Line}{line-graph1}
...
\end{center}
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-02}
%\end{center}
\end{example}

\begin{example}{Graphing Another Line}{line-graph2}
...
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-03}
%\end{center}
\end{example}
...
\begin{example}{Finding Intercepts}{intercepts}
...
\end{center}
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-03(1)}
%\end{center}
\end{example}
...
\begin{example}{Parametric Equations}{parametric-line}
...
%
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-04}
%\end{center}
\end{example}
...
\begin{example}{Horizontal and Vertical Lines}{horiz-vert}
Graph \(x=-2\) and \(y=3\).
...
%
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-05}
%\end{center}
\end{example}
...
\begin{example}{Finding Slope}{slope1}
...
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-07}
%\end{center}
\end{example}

Vertical lines have undefined slope; horizontal lines have slope 0.

\begin{example}{Vertical and Horizontal Slopes}{vertical-horizontal-slope}
...
\begin{example}{Graphing a Line from a Point and Slope}{point-slope-graph}
...
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-09(1)}
%\end{center}
\end{example}
...
\begin{example}{Equation Given Slope and Intercept}{eq-slope-int}
Find the equation of a line with slope \(m=5\) and $y$-intercept \(b=3\).

\textbf{Solution:} \(y=5x+3.\)
\end{example}

\begin{example}{Equation Given a Point and Slope}{eq-point-slope}
...
\begin{example}{Equation Given Two Points}{eq-two-points}
...
\begin{example}{Using Intercepts}{eq-from-intercepts}
...
\begin{example}{Cost Function}{cost-function}
...
\begin{example}{Cost from Two Points}{cost-two-points}
...
\begin{example}{Temperature Conversion}{temp-conversion}
...
\begin{example}{Solving a System}{system-solve}
Solve:
\[
2x+y=7,\quad 3x-y=3.
\]
...
\begin{example}{Equilibrium Point}{equilibrium}
...
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-24}
%\end{center}
\end{example}
...
\begin{example}{Break-Even Analysis}{break-even}
$R=5x$, $C=3x+12$.
...
%\begin{center}
%\includegraphics[width=\textwidth]{applied-finite-mathematics/images/2024_12_11_69ed6e5e21c55666356eg-25}
%\end{center}
\end{example}
