...
\begin{definition}{Particular Solution of a System of Equations}\label{def:particularsolutions}
...
\begin{definition}{Null Space or Kernel of a Linear Transformation}\label{def:nullspaceoflineartransformation}
...
\begin{example}{The Kernel of the Derivative}\label{exa:kernelderivative}
...
\begin{theorem}{Particular Solution and General Solution}\label{thm:particularandgeneralsolution}
...
\begin{example}{The Null Space of a Matrix}\label{exa:matrixnullspace}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrrr}
...
\begin{example}{A General Solution}\label{exa:generalsolution}
