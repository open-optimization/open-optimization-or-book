...
\begin{definition}{Determinant of a Two By Two Matrix}\label{def:twobytwodeterminant}
Let $A=\leftB
\begin{array}{rr}
a & b \\
c & d
...
\begin{example}{A Two by Two Determinant}\label{exa:twobytwodeterminant}
...
\begin{definition}{The $ij^{th}$ Minor of a Matrix}\label{def:ijthminor}
...
\begin{example}{Finding Minors of a Matrix}\label{exa:findingminors}
Let 
\begin{equation*}
A = \leftB
\begin{array}{rrr}
...
\begin{definition}{The $ij^{th}$ Cofactor of a Matrix}\label{def:ijthcofactor}
...
\begin{example}{Finding Cofactors of a Matrix}\label{exa:findingcofactors}
Consider the matrix
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{definition}{The Determinant of a Three By Three Matrix}\label{def:threebythreedeterminant}
...
\begin{example}{Finding the Determinant of a Three by Three Matrix}\label{exa:determinantthreebythree}
Let 
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{theorem}{The Determinant is Well Defined}\label{thm:welldefineddeterminant}
...
\begin{example}{Determinant of a Four by Four Matrix}\label{exa:fourbyfourdeterminant}
...
\begin{definition}{The Determinant of an $n\times n$ Matrix}\label{def:nbyndeterminant}
