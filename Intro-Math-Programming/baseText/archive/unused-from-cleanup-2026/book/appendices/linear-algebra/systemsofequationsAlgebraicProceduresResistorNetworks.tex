...
\begin{theorem}{Kirchhoff's Law}\label{thm:kirchhofflaw}
...
\begin{example}{Solving for Current}\label{exa:solvecurrent}
...
\begin{example}{Unknown Currents}\label{exa:unknowncurrent}
