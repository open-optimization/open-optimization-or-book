...
\begin{example}{Solving an Inequality}\label{exa:solvinginequality1}
...
\begin{example}{Solving an Inequality}\label{exa:solvinginequality2}
...
\begin{example}{Solving an Inequality}\label{exa:solvinginequality3}
