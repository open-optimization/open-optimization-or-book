...
\begin{lemma}{Mapping of a Basis}\label{lem:mappingbasis}
...
\begin{definition}{Coordinate Vector}\label{def:coordinatevector}
...
\begin{example}{Coordinate Vector}\label{exa:coordinatevector}
...
\begin{theorem}{$C_B$ is a Linear Transformation}\label{thm:coordlintransf}
...
\begin{theorem}{The Matrix of a Linear Transformation}\label{thm:matrixlintransfbases}
...
\begin{example}{Matrix of a Linear Transformation}\label{exa:matrixlintransf}
...
\begin{example}{Matrix of a Linear Transformation with respect to an Arbitrary   Basis}\label{exa:arbitrarybases}
