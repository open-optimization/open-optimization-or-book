...
\begin{definition}{Elementary Matrices and Row Operations}\label{def:elementarymatricesandrowops}
...
\begin{theorem}{Multiplication by an Elementary Matrix and Row Operations}\label{thm:multbyelemmatrix}
...
\begin{lemma}{Action of Permutation Matrix}\label{lem:permutationmatrix}
...
\begin{example}{Switching Rows with an Elementary Matrix}\label{exa:elementarymatrixswitchingrows}
Let
\begin{equation*}
P^{12} = \leftB
\begin{array}{rrr}
...
\begin{lemma}{Multiplication by a Scalar and Elementary Matrices}\label{lem:elemmatrixmultbyscalar}
...
\begin{example}{Multiplication of a Row by 5 Using Elementary Matrix}\label{exa:elemmatrixmultbyscalar}
Let
\begin{equation*}
...
\begin{lemma}{Adding Multiples of Rows and Elementary Matrices}\label{lem:addingrowselemmatrix}
...
\begin{example}{Adding Two Times the First Row to the Last}\label{exa:twotimesrowelemmatrix}
Let
\begin{equation*}
...
\begin{theorem}{Elementary Matrices and Inverses}\label{thm:inverseelemmatrix}
...
\begin{example}{Inverse of an Elementary Matrix}\label{exa:inverseelemmatrix}
Let 
\begin{equation*}
E
=
...
\begin{definition}{The Form $B=UA$}\label{def:formbua}
...
\begin{example}{The Form $B=UA$}\label{exa:formbua}
Let $A = \leftB
\begin{array}{rr}
0 & 1 \\
1 & 0 \\
...
\begin{theorem}{Finding the Matrix $U$}\label{thm:findingu}
...
\begin{example}{The Form $B=UA$, Revisited}\label{exa:formbuarevisited}
Let $A = \leftB 
\begin{array}{rr} 
0 & 1 \\
1 & 0 \\
...
\begin{theorem}{Product of Elementary Matrices}\label{thm:prodelem}
Let $A$ be an $n \times n$ matrix. Then $A$ is invertible if and only if it can be written as a product of elementary matrices.
\end{theorem}

Consider the following example.

\begin{example}{Product of Elementary Matrices}\label{exa:prodelem}
Let $A = \leftB
\begin{array}{rrr}
0 & 1 & 0 \\
1 & 1 & 0 \\
