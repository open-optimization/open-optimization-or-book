...
\begin{definition}{Parallelepiped}\label{def:parallelepiped}
A parallelepiped
...
\begin{proposition}{The Box Product}\label{prop:boxproduct}
...
\begin{example}{Volume of a Parallelepiped}\label{exa:parallelepipedvolume}
...
\begin{proposition}{Order of the Product}\label{prop:orderofproduct}
