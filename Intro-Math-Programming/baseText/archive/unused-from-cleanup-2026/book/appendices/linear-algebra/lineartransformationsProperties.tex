...
\begin{theorem}{Properties of Linear Transformations}\label{thm:properties}
...
\begin{example}{Linear Combination}\label{exa:lintransfcombination}
...
\begin{definition}{Equal Transformations}\label{def:equaltransformations}
...
\begin{definition}{Composition of Linear Transformations}\label{def:compositetransformations}
...
\begin{theorem}{Composition of Transformations}\label{thm:compositetransformation}
...
\begin{example}{Composition of Transformations}\label{exa:compositetransformation}
...
\begin{definition}{Inverse of a Transformation}\label{def:inversetransformation}
...
\begin{theorem}{Inverse of a Transformation}\label{thm:inversetransformation}
...
\begin{example}{Inverse of a Transformation}\label{exa:inversetransformation}
