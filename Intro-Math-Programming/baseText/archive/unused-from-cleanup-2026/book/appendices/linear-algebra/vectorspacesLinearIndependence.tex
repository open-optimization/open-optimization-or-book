...
\begin{definition}{Linear Independence}\label{def:linearindependencevectorspace}
...
\begin{example}{Linear Independence}\label{exa:linearindependencepoly}
...
\begin{example}{Dependent Set}\label{exa:dependent}
...
\begin{lemma}{Dependent Sets}\label{lem:dependent}
...
\begin{example}{Related Independent Sets}\label{exa:relatedindependent}
...
\begin{theorem}{Unique Representation}\label{thm:uniquerepresentation}
...
\begin{lemma}{Adding to a Linearly Independent Set}\label{lem:addinglinearlyindependent}
...
\begin{example}{Adding to a Linearly Independent Set}\label{exa:addinglinind}
