...
\begin{definition}{Vector Equation of a Line}\label{def:vectorequationofline}
...
\begin{proposition}{Algebraic Description of a Straight Line}\label{prop:algebraicstraightline}
...
\begin{example}{A Line From Two Points}\label{exa:linefromtwopoints}
...
\begin{example}{A Line From a Point and a Direction Vector}\label{exa:linepointanddirectionvector}
...
\begin{definition}{Parametric Equation of a Line}\label{def:parametricequation}
...
\begin{example}{Change Symmetric Form to Parametric Form}\label{exa:symmetrictoparametric}
Suppose the
