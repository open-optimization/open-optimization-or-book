...
%
\begin{definition}{Similar Matrices}\label{def:similarmatrices}
...
%
\begin{lemma}{Similar Matrices and Eigenvalues}\label{lem:similarmatrices}
...
%example.
%
\begin{example}{Simplify Using Elementary Matrices}\label{exa:simplifyusingelementarymatrices}
...
\begin{example}{Eigenvalues for a Triangular Matrix}\label{exa:eigenvaluestriangularmatrix}
Let $A=\leftB
\begin{array}{rrr}
1 & 2 & 4 \\
0 & 4 & 7 \\
