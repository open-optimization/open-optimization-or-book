...
\begin{definition}{Linear Combination}\label{def:linearcombination}
...
\begin{definition}{Span of Vectors}\label{def:span}
...
\begin{example}{Matrix Span}\label{exa:matrixspan}
...
\begin{example}{Polynomial Span}\label{exa:polyspan}
...
\begin{example}{Spanning Set}\label{exa:spanningset}
