...
\begin{definition}{Linear Transformation}\label{def:lineartransformation}
...
\begin{example}{Linear Transformations}\label{exa:lineartransformations}
...
\begin{example}{Linear Combination}\label{exa:lintransfcombination2}
...
\begin{theorem}{Transformation of a Spanning Set}\label{thm:transformationspanningset}
...
\begin{theorem}{Transformation of a Basis}\label{thm:transformationbasis}
