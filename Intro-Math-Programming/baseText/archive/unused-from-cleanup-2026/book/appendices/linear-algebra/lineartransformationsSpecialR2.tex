...
\begin{theorem}{Rotation}\label{thm:rotation}
...
\begin{example}{Rotation in $\mathbb{R}^2$}\label{exa:rotation}
...
\begin{example}{The Rotation Matrix of the Sum of Two Angles}\label{exa:rotationmatrixtwoangles}
...
\begin{example}{Reflection in $\mathbb{R}^2$}\label{exa:reflection}
...
\begin{example}{Rotation Followed by a Reflection}\label{exa:rotationreflection}
