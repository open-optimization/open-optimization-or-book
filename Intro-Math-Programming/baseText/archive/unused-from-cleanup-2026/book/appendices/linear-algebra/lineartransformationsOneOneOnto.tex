...
\begin{lemma}{Range of a Matrix Transformation}\label{lem:Ax}
...
\begin{definition}{One to One}\label{def:onetoone}
...
\begin{proposition}{One to One}\label{prop:onetoonematrices}
...
\begin{example}{A One to One and Onto Linear Transformation}\label{exa:onetooneontolineartransformation}
Suppose
\begin{equation*}
T\leftB
\begin{array}{c}
...
\begin{example}{An Onto Transformation}\label{exa:ontotransformation}
...
\begin{theorem}{Matrix of a One to One or Onto Transformation}\label{thm:matrixonetooneonto}
...
\begin{example}{An Onto Transformation}\label{exa:ontotransformationmatrix}
Let $T: \mathbb{R}^4 \mapsto \mathbb{R}^2$ be a linear transformation defined by
\[
T \leftB \begin{array}{c}
a \\
...
\begin{example}{Composite of Onto Transformations}\label{exa:compositeonto}
...
\begin{example}{Composite of One to One Transformations}\label{exa:compositeonetoone}
Let $T: \mathbb{R}^k \mapsto \mathbb{R}^n$ and $S: \mathbb{R}^n \mapsto \mathbb{R}^m$ be linear transformations. 
