...
\begin{example}{Isomorphism}\label{exa:isomorphism}
...
\begin{proposition}{Inverse of an Isomorphism}\label{prop:inverseisomorphism}
...
\begin{proposition}{Composition of Isomorphisms}\label{prop:compositionisomorphisms}
...
\begin{example}{Matrix Isomorphism}\label{exa:matrixisomorphism}
...
\begin{lemma}{Mapping Bases}\label{lem:mappingbases}
...
\begin{theorem}{Isomorphic Subspaces}\label{thm:isomorphicsubspaces}
...
\begin{example}{Finding the Matrix of an Isomorphism}\label{exa:matrixofisomorphism}
Let $V=\mathbb{R}^{3}$ and let $W$ denote 
\begin{equation*}
\func{span}\left\{ \leftB 
\begin{array}{c}
