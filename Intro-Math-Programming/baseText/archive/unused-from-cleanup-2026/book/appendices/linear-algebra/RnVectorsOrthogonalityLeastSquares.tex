...
\begin{theorem}{Existence of Minimizers}\label{thm:existenceminimizerhs}\label{existenceminimizerhs}
...
\begin{lemma}{Transpose and Dot Product}\label{lem:transposeanddotprod}
...
\begin{corollary}{Least Squares and Normal Equation}\label{cor:normalEquation}
...
\begin{example}{Least Squares Regression Line}\label{exa:leastSquaresLine}
