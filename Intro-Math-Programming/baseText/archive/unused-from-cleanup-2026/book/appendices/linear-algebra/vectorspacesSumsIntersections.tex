...
\begin{definition}{Sum and Intersection}\label{def:sumintersection}
...
\begin{definition}{Direct Sum}\label{def:directsum}
...
\begin{example}{Intersection is a Subspace}\label{exa:intersectionsubspace}
...
\begin{theorem}{Dimension of Sum}\label{thm:dimensionsum}
