...
\begin{theorem}{Principal Axis Theorem}\label{thm:principalaxis}
...
\begin{example}{Orthogonal Diagonalization of a Symmetric Matrix}\label{exa:orthogonaldiagonalization}
Let $A=\leftB
\begin{array}{rrr}
1 & 0 & 0 \\
...
\begin{example}{Powers of a Symmetric Matrix}\label{exa:powerssymmetricmatrix}
Let $A=\leftB
\begin{array}{rrr}
1 & 0 & 0 \\
0 & \vspace{0.05in}\frac{3}{2} & \vspace{0.05in}\frac{1}{2} \\
