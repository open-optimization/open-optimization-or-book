...
\begin{definition}{Right Hand System of Vectors}\label{def:righthand}
...
\begin{definition}{Geometric Definition of Cross Product}\label{def:crossprodgeomet}
...
\begin{proposition}{Coordinate Description of Cross Product}\label{prop:crossprodcoord}
...
\begin{proposition}{Properties of the Cross Product}\label{prop:propertiescrossproduct}
...
\begin{example}{Find a Cross Product}\label{exa:findcrossproduct}
...
\begin{example}{Area of a Parallelogram}\label{exa:areaparallelogram}
...
\begin{example}{Area of Triangle}\label{exa:areatriangle}
