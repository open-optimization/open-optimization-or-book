...
\begin{theorem}{Subspace Test}\label{thm:subspacetest}
...
\begin{example}{Subspace of $\mathbb{R}^3$}\label{exa:linesubspace}
...
\begin{theorem}{Subspaces are Spans}\label{thm:subspacesarespans}
...
\begin{corollary}{Subspaces are Spans of Independent Vectors}\label{cor:subspacesarespansindependentvectors}
...
\begin{definition}{Standard Basis of $\mathbb{R}^n$}\label{def:standardbasis}
...
\begin{theorem}{Bases of $\mathbb{R}^{n}$ are of the Same Size}\label{thm:basessamesize}
...
\begin{definition}{Dimension of a Subspace}\label{def:dimension}
...
\begin{corollary}{Dimension of $\mathbb{R}^n$}\label{cor:dimensionRn}
...
\begin{example}{Basis of Subspace}\label{exa:basissubspace}
Let 
\[ V=\left\{
...
\begin{corollary}{Linearly Independent and Spanning Sets in  $\mathbb{R}^{n}$}\label{cor:independentspanningRn}
...
\begin{theorem}{Existence of Basis}\label{thm:existencebasis}
...
\begin{example}{Extending an Independent Set}\label{exa:extendindependent}
...
\begin{example}{Subset of a Span}\label{exa:subsetbasis}
...
\begin{theorem}{Subset of a Subspace}\label{thm:subsetdimension}
Let $V$ and $W$ be subspaces of $\mathbb{R}^n$, and suppose that $W\subseteq V$.
Then  $\dim(W) \leq \dim(V)$ with equality when $W=V$.
\end{theorem}

\begin{theorem}{Extending a Basis}\label{thm:extendingbasis}
...
\begin{example}{Extending a Basis}\label{exa:extendingbasis}
