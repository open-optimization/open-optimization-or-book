...
\begin{definition}{Isomorphic}\label{def:isomorphic}
Let $V$ and $W$ be two vector spaces and let $T: V \mapsto W$ be a linear transformation. 
...
\begin{definition}{Composition of Transformations}\label{def:compositetransformation}
...
\begin{proposition}{Composite and Inverse Isomorphism}\label{prop:compositeinverse}
...
\begin{lemma}{Bases and Isomorphisms}\label{lem:basesisomorphism}
...
\begin{theorem}{Isomorphic Vector Spaces}\label{thm:isomorphicvectorspaces}
