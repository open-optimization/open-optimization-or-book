...
\begin{example}{Eigenvectors and Eigenvalues}\label{exa:eigenvectorsandeigenvalues}
Let
\begin{equation*}
A = \leftB
\begin{array}{rrr}
...
\begin{definition}{Eigenvalues and Eigenvectors}\label{def:eigenvaluesandeigenvectors}
...
\begin{theorem}{The Existence of an Eigenvector}\label{thm:existenceofeigenvector}
