...
\begin{definition}{Normal Vector}\label{def:normalvector}
...
\begin{definition}{Vector Equation of a Plane}\label{def:vecteqnplane}
...
\begin{example}{A Point in a Plane}\label{exa:pointplane}
Let $\vect{n} = 
\leftB
\begin{array}{r}
1 \\
...
\begin{definition}{Scalar Equation of a Plane}\label{def:scalareqnplane}
Let $\vect{n} = \leftB 
\begin{array}{c}
a \\
b \\
...
\begin{example}{Finding the Equation of a Plane}\label{exa:findingeqnplane}
...
\begin{example}{Shortest Distance From a Point to a Plane}\label{exa:shortestdistanceplane}
