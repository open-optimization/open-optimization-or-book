...
\begin{definition}{Force}\label{def:force}
\textbf{Force}
...
\begin{example}{The Resultant of Three Forces}\label{exa:resultantthreeforces}
...
\begin{example}{Finding a Vector from Geometric Description}\label{exa:vectorfromgeometricdescription}
...
\begin{definition}{Speed and Velocity}\label{def:speedvelocity}
The \textbf{speed}
...
\begin{example}{Position From Velocity and Time}\label{exa:positionvelocitytime}
...
\begin{example}{Sum of Two Velocities}\label{exa:sumoftwovelocities}
