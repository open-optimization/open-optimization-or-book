...
\begin{lemma}{Invertible Matrix and Zeros}\label{lem:nozerorow}
...
\begin{lemma}{Size of Invertible Matrix}\label{lem:sizeinvertible}
...
\begin{theorem}{Invertible Matrices are Square}\label{thm:squareinvertible}
...
\begin{proposition}{\RREF of a Square Matrix}\label{prop:rrefsquare}
...
\begin{theorem}{Unique Inverse of a Matrix}\label{thm:uniqueinverseofmatrix}
...
\begin{example}{Non Square Matrices}\label{exa:nonsquare}
Let 
\begin{equation*}
A =
\leftB
...
\begin{theorem}{The \RREF of an Invertible Matrix}\label{thm:invertiblerref}
