...
\begin{definition}{Multiplicity of an Eigenvalue}\label{def:multiplicity}
...
\begin{procedure}{Finding Eigenvalues and Eigenvectors}\label{proc:findeigenvaluesvectors}
...
\begin{example}{Find the Eigenvalues and Eigenvectors}\label{exa:findeigenvectors2x2}
...
\begin{example}{Find the Eigenvalues and Eigenvectors}\label{exa:findeigenvectors}
...
\begin{example}{A Zero Eigenvalue}\label{exa:zeroeigenvalue}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrr}
