...
\begin{definition}{Span of a Set of Vectors and Subspace}\label{def:span}
...
\begin{example}{Span of Vectors}\label{exa:spanvectors}
...
\begin{definition}{Linearly Independent Set of Vectors}\label{def:linearindependentortho}
...
\begin{example}{Linearly Independent Vectors}\label{exa:linearlyindependentvectors}
...
\begin{definition}{Basis of a Subspace}\label{def:subspacebasis}
...
\begin{definition}{Orthogonal Set of Vectors}\label{def:orthset}
...
\begin{definition}{Orthonormal Set of Vectors}\label{def:orthoSetVectors}
...
\begin{definition}{Normalizing an Orthogonal Set}\label{def:normalizing}
...
\begin{example}{Orthonormal Set}\label{exa:orthonormalset}
...
\begin{theorem}{Orthogonal Basis of a Subspace}\label{thm:orthbasis}
...
\begin{theorem}{Fourier Expansion}\label{thm:fourierexpansion}
...
\begin{example}{Fourier Expansion}\label{exa:fourier}
Let
