...
\begin{definition}{Row Operations}\label{def:operations}
...
\begin{theorem}{Switching Rows}\label{thm:switchingrows}
...
\begin{example}{Switching Two Rows}\label{exa:switchingrows}
Let $A=\leftB
\begin{array}{rr}
1 & 2 \\
3 & 4
...
\begin{theorem}{Multiplying a Row by a Scalar}\label{thm:multiplyingrowbyscalar}
Let $A$ be an $n\times n$ matrix and let $B$ be a matrix
...
\begin{theorem}{Scalar Multiplication}\label{thm:scalarmultdet}
Let $A$ and $B$ be $n \times n$ matrices and $k$ a scalar, such that $B = kA$. Then $\det(B) = k^n \det(A)$.
\end{theorem}

Consider the following example.

\begin{example}{Multiplying a Row by 5}\label{exa:5timesrow}
Let $A=\leftB
\begin{array}{rr}
1 & 2 \\
3 & 4
...
\begin{theorem}{Adding a Multiple of a Row to Another Row}\label{thm:addingmultipleofrow}
Let $A$ be an $n\times n$ matrix and let $B$ be a matrix
...
\begin{example}{Adding a Row to Another Row}\label{exa:addingrow}
Let $A=\leftB
\begin{array}{rr}
1 & 2 \\
3 & 4
...
\begin{example}{Multiple of a Row}\label{exa:multiplerows}
...
\begin{theorem}{Determinant of a Product}\label{thm:determinantofproduct}
...
\begin{example}{The Determinant of a Product}\label{exa:determinantofproduct}
...
\begin{theorem}{Determinant of the Transpose}\label{thm:transposedeterminant}
...
\begin{example}{Determinant of the Transpose}\label{exa:transposedeterminant}
Let
\begin{equation*}
A
=
...
\begin{theorem}{Determinant of the Inverse}\label{thm:detinverse}
...
\begin{example}{Determinant of an Invertible Matrix}\label{exa:detinvertiblematrix}
Let $A = \leftB \begin{array}{rr}
3 & 6 \\
2 & 4 
