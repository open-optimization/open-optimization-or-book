...
\begin{theorem}{De Moivre's Theorem}\label{thm:demoivretheorem}
...
\begin{corollary}{Roots of Complex Numbers}\label{cor:rootscomplexnumbers}
...
\begin{procedure}{Finding Roots of a Complex Number}\label{proc:findingkthroots}
...
\begin{example}{Finding Cube Roots}\label{exa:cuberoots}
...
\begin{example}{Solving a Polynomial Equation}\label{exa:solvingpolynomial}
