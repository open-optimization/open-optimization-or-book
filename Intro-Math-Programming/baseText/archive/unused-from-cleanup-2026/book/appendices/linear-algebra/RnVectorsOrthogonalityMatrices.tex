...
\begin{definition}{Orthogonal Matrices}\label{def:OrthoMatrix}
...
\begin{proposition}{Orthonormal Basis}\label{prop:orthbasis}
...
\begin{proposition}{Determinant of Orthogonal Matrices}\label{prop:orthoDet}
...
\begin{example}{Product and Inverse of Orthogonal Matrices}\label{exa:productinverseorthogonal}
