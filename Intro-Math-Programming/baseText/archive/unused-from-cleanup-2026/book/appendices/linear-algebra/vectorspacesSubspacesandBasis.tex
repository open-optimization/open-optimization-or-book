...
\begin{theorem}{Subspaces are Vector Spaces}\label{thm:subspacesarevectorspaces}
...
\begin{corollary}{Span is a Subspace}\label{cor:spansubspace}
...
\begin{theorem}{Spanning Set}\label{thm:spanningset}
...
\begin{example}{Equal Span}\label{exa:equalspan}
...
\begin{procedure}{Subspace Test}\label{proc:subspacetest}
...
\begin{example}{Improper Subspaces}\label{exa:impropersubspaces}
...
\begin{example}{Subspace of Polynomials}\label{exa:polysubspace}
...
\begin{definition}{Basis}\label{def:basisvectorspace}
...
\begin{example}{Polynomials of Degree Two}\label{exa:polydegreetwo}
...
\begin{theorem}{Exchange Theorem}\label{thm:exchangetheorem}
...
\begin{corollary}{Two Bases of the Same Length}\label{cor:baseslength}
...
\begin{definition}{Dimension}\label{def:dimensionvectorspace}
...
\begin{example}{Dimension of a Vector Space}\label{exa:dimension}
...
\begin{example}{A Different Basis for Polynomials of Degree Two}\label{exa:polydegtwodifferentbasis}
...
\begin{theorem}{Every Subspace has a Basis}\label{thm:everysubspacebasis}
...
\begin{theorem}{Subspace of Same Dimension}\label{thm:subspacevectorspace}
...
\begin{example}{Basis of a Subspace}\label{exa:basissubspace}
...
\begin{theorem}{Basis of $V$}\label{thm:basisfromspanninglinind}
...
\begin{example}{Adding to a Linearly Independent Set}\label{exa:addinglinearindbasis}
...
\begin{example}{Shrinking a Spanning Set}\label{exa:shrinkspanning}
...
\begin{theorem}{Basis of a Vector Space}\label{thm:basisvectorspace}
