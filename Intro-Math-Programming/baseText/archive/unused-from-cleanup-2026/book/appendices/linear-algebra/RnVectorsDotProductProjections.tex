...
\begin{theorem}{Vector Projections}\label{thm:projection}
...
\begin{definition}{Vector Projection}\label{def:projection}
...
\begin{example}{Find the Projection of One Vector Onto Another}\label{exa:vectorprojection}
Find 
...
\begin{example}{Shortest Distance from a Point to a Line}\label{exa:shortestpointline}
