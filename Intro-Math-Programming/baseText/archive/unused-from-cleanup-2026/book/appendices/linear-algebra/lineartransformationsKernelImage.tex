...
\begin{definition}{Kernel and Image}\label{def:kernelimage}
...
\begin{proposition}{Kernel and Image as Subspaces}\label{prop:kernelimagesubspaces}
...
\begin{example}{Kernel and Image of a Linear Transformation}\label{exa:kernelimage}
...
\begin{theorem}{One to One and Kernel}\label{thm:onetoonekernel}
...
\begin{theorem}{Dimension of Kernel and Image}\label{thm:dimensionkernelimage}
