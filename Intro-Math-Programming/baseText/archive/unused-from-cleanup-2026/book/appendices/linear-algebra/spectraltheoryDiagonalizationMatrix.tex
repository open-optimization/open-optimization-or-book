...
\begin{theorem}{Eigenvectors and Diagonalizable Matrices}\label{thm:eigenvectorsanddiagonalizable}
...
\begin{example}{Diagonalize a Matrix}\label{exa:diagonalizematrix}
Let 
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{theorem}{Linearly Independent Eigenvectors}\label{thm:linindepeigenvectors}
...
\begin{corollary}{Distinct Eigenvalues}\label{cor:distincteigenvalues}
...
\begin{example}{A Matrix which cannot be Diagonalized}\label{exa:impossiblediagonalize}
Let
\begin{equation*}
A = 
\leftB
...
\begin{lemma}{Dimension of the Eigenspace}\label{lem:dimensioneigenspace}
...
\begin{theorem}{Diagonalizability Condition}\label{thm:diagonalizability}
