...
\begin{example}{Polynomial Interpolation}\label{exa:polynomialinterpolation}
...
\begin{procedure}{Finding an Interpolating Polynomial}\label{proc:findinginterpolynomial}
...
\begin{theorem}{Polynomial Interpolation}\label{thm:polynomialinterpolation}
...
\begin{example}{Polynomial Interpolation}\label{exa:polynomialinterpolation2}
