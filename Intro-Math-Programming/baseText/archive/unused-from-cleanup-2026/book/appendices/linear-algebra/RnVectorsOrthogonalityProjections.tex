...
\begin{definition}{Orthogonal Projection}\label{def:orthproj}
...
\begin{theorem}{Approximation Theorem}\label{thm:approximation}
...
\begin{example}{Orthogonal Projection}\label{exa:orthproj}
...
\begin{definition}{Orthogonal Complement}\label{def:orthcomp}
...
\begin{proposition}{Orthogonal to Spanning Set}\label{prop:orthogonalspanningset}
...
\begin{proposition}{The Orthogonal Complement}\label{prop:subspacecomplement}
Let $W$ be a subspace of $\mathbb{R}^n$. Then the orthogonal complement $W^{\perp}$ is also a subspace of $\mathbb{R}^n$.
\end{proposition}

Consider the following proposition.

\begin{proposition}{Orthogonal Complement of $\mathbb{R}^n$}\label{prop:complementofrn}
...
\begin{example}{Orthogonal Complement}\label{exa:orthcomp}
...
\begin{theorem}{Orthogonal Projection}\label{thm:orthproj}
...
\begin{example}{Find a Vector Closest to a Given Vector}\label{exa:vectorclosestvector}
...
\begin{example}{Vector Written as a Sum of Two Vectors}\label{exa:sumoftwovectors}
...
\begin{example}{Point in a Plane Closest to a Given Point}\label{exa:closestplane}
