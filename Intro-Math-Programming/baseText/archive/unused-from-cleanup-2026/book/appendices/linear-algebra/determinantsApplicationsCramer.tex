...
\begin{procedure}{Using Cramer's Rule}\label{proc:cramersrule}
...
\begin{example}{Using Cramer's Rule}\label{exa:cramersrule}
Find $x,y,z$ if
\begin{equation*}
\leftB
\begin{array}{rrr}
...
%
\begin{example}{Use Cramer's Rule for Non-Constant Matrix}\label{exa:cramersrulenonconstantmatrix}
%Solve for $z$ if
\begin{equation*}
\leftB
\begin{array}{ccc}
