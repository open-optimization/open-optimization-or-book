...
\begin{example}{Find Orthonormal Set with Same Span}\label{exa:orthosamespan}
...
\begin{example}{Find a Corresponding Orthogonal Basis}\label{exa:orthogonalbasis}
Let
