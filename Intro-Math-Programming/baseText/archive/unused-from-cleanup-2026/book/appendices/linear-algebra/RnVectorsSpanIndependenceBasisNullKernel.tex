...
\begin{definition}{Row and Column Space}\label{def:rowcolumnspace}
...
\begin{lemma}{Effect of Row Operations on Row Space}\label{lem:rowoperationsrowspace}
...
\begin{lemma}{Row Space of a \EF\;Matrix}\label{lem:echelonformrowspace}
...
\begin{definition}{Rank of a Matrix}\label{def:rankrowspace}
...
\begin{example}{Rank, Column and Row Space}\label{exa:rankcolumnrowspace}
...
\begin{example}{Rank, Column and Row Space}\label{exa:rankcolumnrowspace2}
...
\begin{theorem}{Rank Theorem}\label{thm:ranktheorem}
...
\begin{corollary}{Results of the Rank Theorem}\label{cor:ranktheorem}
...
\begin{example}{Rank of the Transpose}\label{exa:ranktranspose}
Let \[
A = 
\leftB
\begin{array}{rr}
...
\begin{definition}{Null Space, or Kernel, of $A$}\label{def:nullspace}
...
\begin{definition}{Image of $A$}\label{def:image}
...
\begin{example}{Null Space}\label{exa:nullsubspace}
...
\begin{theorem}{Basis of $\func{null}(A)$}\label{thm:nullspacebasis}
...
\begin{example}{Null Space of $A$}\label{exa:nullspace}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{example}{Null Space of $A$}\label{exa:nullspace2}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrrrr}
...
\begin{theorem}{Rank and Nullity}\label{thm:ranknullity}
...
\begin{example}{Rank and Nullity}\label{exa:ranknullity}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrr}
