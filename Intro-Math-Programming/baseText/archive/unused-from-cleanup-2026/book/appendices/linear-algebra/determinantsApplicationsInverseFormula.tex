...
\begin{definition}{The Cofactor Matrix}\label{def:cofactormatrix}
...
\begin{theorem}{The Inverse and the Determinant}\label{thm:inverseanddeterminant}
...
\begin{example}{Find Inverse Using the Determinant}\label{exa:inverseanddeterminant}
...
\begin{example}{Find the Inverse From a Formula}\label{exa:inverseformula}
Find the inverse of the matrix
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{example}{Inverse for Non-Constant Matrix}\label{exa:inversenonconstantmatrix}
Suppose
\begin{equation*}
