...
\begin{theorem}{Properties of Addition of Complex Numbers}\label{thm:propertiesofadditioncomplexnumbers}
...
\begin{example}{Multiplication of Complex Numbers}\label{exa:complexmultiplication}
\begin{itemize}
...
\begin{theorem}{Properties of Multiplication of Complex Numbers}\label{thm:propertiesmultiplicationcomplexnumbers}
...
\begin{definition}{Conjugate of a Complex Number}\label{def:conjugate}
...
\begin{example}{Conjugate of a Complex Number}\label{exa:complexconjugate}
\begin{itemize}
...
\begin{theorem}{Properties of the Conjugate}\label{thm:propertiesconjugate}
...
\begin{example}{Division of Complex Numbers}\label{exa:divisioncomplex}
\begin{itemize}
\item
...
\begin{definition}{Inverse of a Complex Number}\label{def:complexinverse}
...
\begin{example}{Inverse of a Complex Number}\label{exa:complexinverse}
...
\begin{definition}{Absolute Value}\label{def:complexabsvalue}
...
\begin{proposition}{Triangle Inequality}\label{prop:triangleinequalitycomplex}
