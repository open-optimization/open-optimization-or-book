...
\begin{theorem}{Cholesky Factorization}\label{thm:choleskyfactorization}
...
\begin{procedure}{Finding the Cholesky Factorization}\label{proc:findingcholesky}
...
\begin{example}{Cholesky Factorization}\label{exa:cholesky}
Show that
