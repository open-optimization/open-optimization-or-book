...
\begin{definition}{Polar Form of a Complex Number}\label{def:polarform}
...
\begin{example}{Standard to Polar Form}\label{exa:polarform}
...
\begin{example}{Polar to Standard Form}\label{exa:polarstandardform}
