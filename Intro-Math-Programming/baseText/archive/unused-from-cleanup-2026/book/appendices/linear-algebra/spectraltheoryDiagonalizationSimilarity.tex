...
\begin{lemma}{Similarity is an Equivalence Relation}\label{lem:similarityequivalence}
...
\begin{definition}{Trace of a Matrix}\label{def:matrixtrace}
...
\begin{lemma}{Properties of Trace}\label{lem:traceproperties}
...
\begin{theorem}{Properties of Similar Matrices}\label{thm:propertiessimilar}
