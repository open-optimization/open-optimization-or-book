...
\begin{definition}{Vector Space}\label{def:vectorspace}
...
\begin{definition}{Axioms of Addition}\label{def:vectorspaceaxiomsaddition}
...
\begin{definition}{Axioms of Scalar Multiplication}\label{def:vectorspaceaxiomsscalarmult}
...
\begin{example}{$\mathbb{R}^n$}\label{exa:Rnvectorspace}
...
\begin{example}{Vector Space of Polynomials}\label{exa:vectorspacepoly}
...
\begin{example}{Vector Space of Matrices}\label{exa:vectorspacematrices}
...
\begin{example}{Not a Vector Space}\label{exa:notvectorspace}
...
\begin{example}{Vector Space of Functions}\label{exa:vectorspacefunction}
...
\begin{theorem}{Uniqueness}\label{thm:axiomuniqueness}
