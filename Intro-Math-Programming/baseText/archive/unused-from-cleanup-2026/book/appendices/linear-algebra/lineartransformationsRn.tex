...
\begin{example}{A Function Which Transforms Vectors}\label{exa:functiontransformation}
...
\begin{example}{Linear Transformation}\label{exa:lineartransformation}
...
\begin{theorem}{Matrix Transformations are Linear Transformations}\label{thm:matrixarelinear}
