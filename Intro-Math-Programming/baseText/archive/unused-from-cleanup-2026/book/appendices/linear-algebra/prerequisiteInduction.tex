...
\begin{definition}{Well Ordered}\label{def:wellordered}
...
\begin{proposition}{Well Ordered Sets}\label{prop:wellordered}
...
\begin{theorem}{Mathematical Induction}\label{thm:mathinduction}
...
\begin{procedure}{Proof by Mathematical Induction}\label{proc:mathinduction}
...
\begin{example}{Proving by Induction}\label{exa:proofbyinduction}
...
\begin{example}{Proving an Inequality by Induction}\label{exa:inequalityproofbyinduction}
