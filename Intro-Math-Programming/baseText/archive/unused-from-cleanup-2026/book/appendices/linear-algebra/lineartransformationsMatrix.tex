...
\begin{theorem}{Matrix of a Linear Transformation}\label{thm:matrixlintransf}
...
\begin{theorem}{Matrix of a Linear Transformation}\label{thm:matrixoflineartransformation}
...
\begin{corollary}{Matrix and Linear Transformation}\label{cor:matrixlintransfequivalence}
A transformation $T$ is a linear transformation if and only if it is a matrix transformation. 
\end{corollary}

Consider the following example.

\begin{example}{The Matrix of a Linear Transformation}\label{exa:matrixoflineartransformation}
...
\begin{example}{The Matrix of Linear Transformation: Inconveniently \\ Defined}\label{exa:2x2inconvenientmatrixoflintransf}
...
\begin{procedure}{Finding the Matrix of Inconveniently Defined Linear Transformation}\label{proc:findingmatrixoflineartransformation}
...
\begin{example}{Matrix of a Linear Transformation \\ Given Inconveniently}\label{exa:inconvenientmatrixlintransf}
...
\begin{example}{Matrix of a Projection Map}\label{exa:projectionmatrix}
