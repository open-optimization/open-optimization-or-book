...
\begin{example}{Solutions to Quadratic Equation}\label{exa:quadraticequation}
...
\begin{example}{Solutions to Quadratic Equation}\label{exa:quadraticequationcomplex}
...
\begin{theorem}{The Fundamental Theorem of Algebra}\label{thm:fundtheorem}
