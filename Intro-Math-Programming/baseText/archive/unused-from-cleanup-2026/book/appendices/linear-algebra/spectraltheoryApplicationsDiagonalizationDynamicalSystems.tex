...
\begin{definition}{Matrix Recurrence}\label{def:matrixrecurrence}
...
\begin{procedure}{Solving a Dynamical System}\label{proc:solvingdynamical}
Suppose a dynamical system is given by  
\begin{eqnarray*}
x_{n+1} &=& a x_n + b y_n \\
y_{n+1} &=& c x_n + d y_n
...
\begin{example}{Solutions of a Discrete Dynamical System}\label{exa:solutionsdynamicalsystem}
Suppose a dynamical system is given by 
\begin{eqnarray*}
...
\begin{example}{Finding Solutions to a Dynamical System}\label{exa:findsolutionsdynamicalsystem}
...
\begin{example}{The Fibonacci Sequence}\label{exa:fibonacci}
