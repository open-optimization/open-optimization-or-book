...
\begin{definition}{Migration Matrices}\label{def:migrationmatrix}
...
\begin{example}{Migration Matrix}\label{exa:migrationmatrix}
...
\begin{theorem}{State Vector}\label{thm:statevector}
...
\begin{example}{Using a Migration Matrix}\label{exa:usingmigrationmatrix}
...
\begin{example}{Random Walks}\label{exa:randomwalks}
...
\begin{theorem}{Steady State Vector}\label{thm:steadystate}
...
\begin{example}{Populations over the Long Run}\label{exa:longrunpopulation}
Consider the migration matrix 
\begin{equation*}
A
=
...
\begin{example}{Populations After a Long Time}\label{exa:populationafterlongtime}
