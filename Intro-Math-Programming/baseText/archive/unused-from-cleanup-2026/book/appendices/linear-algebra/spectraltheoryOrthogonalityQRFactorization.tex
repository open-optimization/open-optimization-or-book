...
\begin{definition}{$QR$ Factorization}\label{def:qrfactorization}
...
\begin{theorem}{Existence of $QR$ Factorization}\label{thm:existenceqr}
...
\begin{procedure}{$QR$ Factorization}\label{proc:qrfactorization}
...
\begin{example}{Finding a $QR$ Factorization}\label{exa:qrfactorization}
Let \[
