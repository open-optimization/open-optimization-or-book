...
\begin{definition}{Positive Definite Matrix}\label{def:positivedefinitematrix}
...
\begin{lemma}{Negative Definite Matrix}\label{lem:negativedefinitematrix}
...
%\medskip
%%
%\begin{theorem}{Positive Definite Matrix and Eigenvalues}\label{thm:posdefeigen}  %\label{3oct3f}
...
\begin{lemma}{Positive Definite Matrix and Invertibility}\label{lem:posdefiniteinvertible}
...
\begin{theorem}{Positive Definite Matrix}\label{thm:positivedefinite}
...
\begin{definition}{The Submatrix $A_k$}\label{def:submatrixAk}
...
\begin{lemma}{Positive Definite and Submatrices}\label{lem:positivematrixsubmatrix}
...
\begin{theorem}{Positive Matrix and Determinant of $A_k$}\label{thm:positivematrixdeterminantAk}   
...
\begin{corollary}{Symmetric and Negative Definite Matrix}\label{cor:symmetricdefinitematrix} \label{pd3} 
