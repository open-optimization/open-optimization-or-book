...
\makeatletter
\def\input@path{{book/preamble/}{book/preamble/algorithmicx/}}
\makeatother
...
\usepackage{book/preamble/algorithmicx/algorithmicx}
...
\usepackage[plain]{book/preamble/algorithm}
\usepackage[noend]{book/preamble/algorithmicx/algpseudocode}
...
\input{book/preamble/preamble-optimization}
%\input{optimization/merged_preamble}
%\input{optimization/preamble_merged_restructured}
\input{book/preamble/preamble0}
\input{book/preamble/preamble0-biblatex}
\input{book/preamble/preamble-jupyter.tex}
...
\graphicspath{{external-sources/aFirstCourseLinearAlgebra/},{external-sources/lineqlpbook/},{optimization/figures/figures-static/},{external-sources/Christopher_Griffin_Penn_State_University/},{external-sources/OR-Book-Vorwerk/images/}}
