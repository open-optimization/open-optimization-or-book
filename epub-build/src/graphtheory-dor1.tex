...
\begin{center}
\includegraphics[width=2.86in]{figs/graphtheory-dor1-tikz23.png}\par\captionof{figure}{Weighted graph of leasing costs, in thousands of dollars per year, between the five offices A, B, C, D, E.}\label{fig:graphtheory-dor1-tikz23}% fig-num-auto
...
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz24.png}\par\captionof{figure}{A spanning tree on four vertices with three edges.}\label{fig:graphtheory-dor1-tikz24}% fig-num-auto

\end{minipage}
%
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz25.png}\par\captionof{figure}{Another spanning tree on the same four vertices.}\label{fig:graphtheory-dor1-tikz25}% fig-num-auto
...
\includegraphics[width=3.67in]{figs/graphtheory-dor1-tikz39.png}\par\captionof{figure}{Weighted graph with seven vertices A through G for the shortest path exercise.}\label{fig:graphtheory-dor1-tikz39}% fig-num-auto
...
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz40.png}\par\captionof{figure}{Five-vertex graph for the degree exercise.}\label{fig:graphtheory-dor1-tikz40}% fig-num-auto


\item	Find the degree of each vertex in the graph below.\\

\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz41.png}\par\captionof{figure}{Another five-vertex graph for the degree exercise.}\label{fig:graphtheory-dor1-tikz41}% fig-num-auto
...
\includegraphics[width=4.97in]{figs/graphtheory-dor1-tikz50.png}\par\captionof{figure}{Virginia passenger rail network with travel times in minutes.}\label{fig:graphtheory-dor1-tikz50}% fig-num-auto
