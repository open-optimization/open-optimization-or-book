...
}\par\captionof{figure}{Aerial photograph of a Missoula, Montana housing development showing several blocks of houses...}\label{fig:GraphPicture}% fig-num-auto
...
To do that, we first need to simplify the picture into a form that is easier to work with.  We can do that by drawing a simple line for each street.  Where streets intersect, we will place a dot. \\
 ...
 \altincludegraphics{graph-theory-graphics/GraphPictureDot.png}{Side-by-side: the housing aerial photo is overlaid with red dots at intersections and red lines along streets; next to it, the same network is redrawn as a graph of labeled vertices joined by edges, showing the reduction of a street map to a graph.}\par\captionof{figure}{Side-by-side: the housing aerial photo is overlaid with red dots at intersections and red lines...}\label{fig:GraphPictureDot}% fig-num-auto
...
\includegraphics[width=2.36in]{figs/graphtheory-dor1-tikz01.png}\par\captionof{figure}{Eighteen-vertex housing-development graph with nodes A through R laid out on a roughly grid-like...}\label{fig:graphtheory-dor1-tikz01}% fig-num-auto
     
\end{minipage}
%
\begin{minipage}{0.5\textwidth}
\includegraphics[width=2.75in]{figs/graphtheory-dor1-tikz02.png}\par\captionof{figure}{The same 18-vertex graph G (vertices A through R) redrawn with vertices scattered in a non-grid layout.}\label{fig:graphtheory-dor1-tikz02}% fig-num-auto
...
\begin{center}
\altincludegraphics[scale = 0.7]{Figures/Konigsberg_bridges}{Historical map of the Prussian city of Koenigsberg with the river highlighted in blue and the seven bridges that cross its forks marked in green, depicting the geographic setting of the famous Koenigsberg bridge problem that launched graph theory.}\\\par\captionof{figure}{Historical map of the Prussian city of Koenigsberg with the river highlighted in blue and the seven...}\label{fig:Konigsberg_bridges}% fig-num-auto
...
\begin{center}
\includegraphics[width=4.25in]{figs/graphtheory-dor1-tikz03.png}\par\captionof{figure}{Schematic of Konigsberg's four landmasses drawn as labelled ellipses (North Bank, Island, East...}\label{fig:graphtheory-dor1-tikz03}% fig-num-auto
...
\begin{center}
\includegraphics[width=1.67in]{figs/graphtheory-dor1-tikz04.png}\par\captionof{figure}{Graph abstraction of the Konigsberg bridges: four circular vertices labelled NB, I, EB, and SB with...}\label{fig:graphtheory-dor1-tikz04}% fig-num-auto
...
\includegraphics[width=0.95in]{figs/graphtheory-dor1-tikz05.png}\par\captionof{figure}{Small graph illustrating a loop: three filled-dot vertices form a triangle and a red self-loop...}\label{fig:graphtheory-dor1-tikz05}% fig-num-auto
...
\hline
\includegraphics[width=0.21in]{figs/graphtheory-dor1-tikz06.png}
&
\includegraphics[width=0.83in]{figs/graphtheory-dor1-tikz07.png}
&
\includegraphics[width=0.55in]{figs/graphtheory-dor1-tikz08.png}
&
\includegraphics[width=0.91in]{figs/graphtheory-dor1-tikz09.png}
&
\includegraphics[width=0.91in]{figs/graphtheory-dor1-tikz10.png}\\
\hline
\end{tabular}\par\captionof{figure}{Examples of vertices of degree 0 through 4.}\label{fig:graphtheory-dor1-degrees}% fig-num-auto
...
\begin{center}
\includegraphics[width=1.61in]{figs/graphtheory-dor1-tikz11.png}\par\captionof{figure}{A 3-by-4 grid graph with 12 vertices labelled A-D (top), E-H (middle), J-M (bottom).}\label{fig:graphtheory-dor1-tikz11}% fig-num-auto
...
\begin{center}
\includegraphics[width=1.61in]{figs/graphtheory-dor1-tikz12.png}\par\captionof{figure}{The same 3-by-4 grid graph (vertices A-D, E-H, J-M) with a circuit highlighted in thick red...}\label{fig:graphtheory-dor1-tikz12}% fig-num-auto
...
\includegraphics[width=1.61in]{figs/graphtheory-dor1-tikz13.png}\par\captionof{figure}{A 3-by-4 grid graph with vertices A-D, E-H, J-M, but with the column-A horizontal edges deleted so...}\label{fig:graphtheory-dor1-tikz13}% fig-num-auto
...
The graph below shows 5 cities.  The weights on the edges represent the airfare for a one-way flight between the cities.
 ...
 \begin{center}
 \includegraphics[width=4.02in]{figs/graphtheory-dor1-tikz14.png}\par\captionof{figure}{Weighted graph of five U.S. cities (LA, Seattle, Chicago, Atlanta, Dallas) shown as filled dots...}\label{fig:graphtheory-dor1-tikz14}% fig-num-auto
...
\begin{center}
\includegraphics[width=\linewidth]{figs/graphtheory-dor1-tikz15.png}\par\captionof{figure}{Initial-state diagram for Dijkstra's algorithm: seven blue circular nodes T, E, A, NB, MR, P, Y...}\label{fig:graphtheory-dor1-tikz15}% fig-num-auto
...
\includegraphics[width=\linewidth]{figs/graphtheory-dor1-tikz16.png}\par\captionof{figure}{Weighted road network for the Yakima-to-Tacoma example: seven filled-dot vertices T (Tacoma), E...}\label{fig:graphtheory-dor1-tikz16}% fig-num-auto
...
\includegraphics[width=3.81in]{figs/graphtheory-dor1-tikz17.png}\par\captionof{figure}{Yakima-to-Tacoma road network as before, now with the destination Y annotated [0] in red to mark it...}\label{fig:graphtheory-dor1-tikz17}% fig-num-auto
...
\includegraphics[width=3.81in]{figs/graphtheory-dor1-tikz18.png}\par\captionof{figure}{Yakima example after Dijkstra step 2: tentative distances [104] at NB, [96] at MR, [76] at P are...}\label{fig:graphtheory-dor1-tikz18}% fig-num-auto
...
\includegraphics[width=3.81in]{figs/graphtheory-dor1-tikz19.png}\par\captionof{figure}{Yakima example after the second iteration: P is the current vertex; E now has tentative distance...}\label{fig:graphtheory-dor1-tikz19}% fig-num-auto
...
\includegraphics[width=3.81in]{figs/graphtheory-dor1-tikz20.png}\par\captionof{figure}{Yakima example after the third iteration: A has tentative distance [175] (via MR); P and Y appear...}\label{fig:graphtheory-dor1-tikz20}% fig-num-auto
...
\includegraphics[width=3.81in]{figs/graphtheory-dor1-tikz21.png}\par\captionof{figure}{Yakima example after the fourth iteration: A's distance is updated to [140] via NB; NB, MR, P, Y...}\label{fig:graphtheory-dor1-tikz21}% fig-num-auto
...
\includegraphics[width=4.09in]{figs/graphtheory-dor1-tikz22.png}\par\captionof{figure}{Yakima example after the fifth iteration: T receives tentative distance [160] via A; A, NB, MR, P...}\label{fig:graphtheory-dor1-tikz22}% fig-num-auto
...
\begin{center}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra0.png}{Weighted undirected graph for the Dijkstra example. Seven vertices a-g are joined by edges with weights a-b=2, a-c=6, c-d=8, b-d=5, d-e=10, d-f=15, e-f=6, e-g=2, f-g=6. No vertex is yet marked visited.}\\\par\captionof{figure}{Weighted undirected graph for the Dijkstra example.}\label{fig:dijkstra0}% fig-num-auto

\end{center}
We will initialize our algorithm at node 'a'.  

\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra1.png}{Dijkstra step 1: the start vertex a is highlighted in red and labeled with tentative distance 0. Its neighbors b and c receive tentative labels 2 and 6 from a; all other vertices remain labeled infinity.}\par\captionof{figure}{Dijkstra step 1: the start vertex a is highlighted in red and labeled with tentative distance 0.}\label{fig:dijkstra1}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra2.png}{Dijkstra step 2: vertex b is now marked as visited with permanent distance 2, and the edge a-b is highlighted in red. Vertex d is updated through b to tentative distance 7. Labels at c, e, f, and g are unchanged.}\par\captionof{figure}{Dijkstra step 2: vertex b is now marked as visited with permanent distance 2, and the edge a-b is...}\label{fig:dijkstra2}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
     \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra3.png}{Dijkstra step 3: vertex c is marked visited with distance 6 and edge a-c is highlighted. Reaching d through c would give 6+8=14, which is worse than the current label 7, so d's tentative distance is unchanged.}\par\captionof{figure}{Dijkstra step 3: vertex c is marked visited with distance 6 and edge a-c is highlighted.}\label{fig:dijkstra3}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
     \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra4.png}{Dijkstra step 4: vertex d is marked visited with distance 7, and the path a-b-d is highlighted in red. Neighbors of d are updated: e to 17 (via 7+10) and f to 22 (via 7+15); g remains infinity.}\par\captionof{figure}{Dijkstra step 4: vertex d is marked visited with distance 7, and the path a-b-d is highlighted in red.}\label{fig:dijkstra4}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
     \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra5.png}{Dijkstra step 5: vertex e is marked visited with distance 17 and the edge d-e is added to the highlighted path. From e, vertex g is updated to 17+2=19, improving on its previous infinity label.}\par\captionof{figure}{Dijkstra step 5: vertex e is marked visited with distance 17 and the edge d-e is added to the...}\label{fig:dijkstra5}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
     \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra6.png}{Dijkstra step 6: vertex g is marked visited with distance 19, and the edge e-g is highlighted, completing a tentative shortest path a-b-d-e-g. The remaining unvisited vertex f keeps tentative distance 22.}\par\captionof{figure}{Dijkstra step 6: vertex g is marked visited with distance 19, and the edge e-g is highlighted...}\label{fig:dijkstra6}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
     \end{minipage}\\
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra7.png}{Dijkstra step 7: vertex f is marked visited with distance 22 and the edge d-f is highlighted along with the previously found path. All seven vertices are now visited so the algorithm terminates.}\par\captionof{figure}{Dijkstra step 7: vertex f is marked visited with distance 22 and the edge d-f is highlighted along...}\label{fig:dijkstra7}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra8.png}{Final state of the Dijkstra example: every vertex carries its shortest-path distance from a (a=0, b=2, c=6, d=7, e=17, g=19, f=22), and the shortest-path tree found by the algorithm is highlighted in red.}\par\captionof{figure}{Final state of the Dijkstra example: every vertex carries its shortest-path distance from a (a=0...}\label{fig:dijkstra8}% fig-num-auto
...
\begin{center}
\altincludegraphics[scale = 0.5]{graph-theory-graphics/dijkstra-soln.png}{The same seven-vertex weighted graph with the shortest path from a to g highlighted in red: a-b-d-e-g, traversing edges of weight 2, 5, 10, and 2 for a total length of 19.}\par\captionof{figure}{The same seven-vertex weighted graph with the shortest path from a to g highlighted in red...}\label{fig:dijkstra-soln}% fig-num-auto
...
Dallas&&&*&18&15&25\\
 ...
 \hline
 \end{tabular}
\par\captionof{table}{Travel times in hours between processing centers, with three hours added for processing.}\label{tab:graphtheory-dor1-tab01}% tab-num-auto
...
\begin{center}
\includegraphics[width=2.86in]{figs/graphtheory-dor1-tikz23.png}\par\captionof{figure}{A 4-vertex spanning tree drawn as filled dots at corners of a small region, connected by three...}\label{fig:graphtheory-dor1-tikz23}% fig-num-auto
...
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz24.png}\par\captionof{figure}{A 4-vertex spanning tree with three edges arranged as a path: middle vertex linked to top-right...}\label{fig:graphtheory-dor1-tikz24}% fig-num-auto

\end{minipage}
%
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz25.png}\par\captionof{figure}{Composite figure of five small spanning trees with n = 1, 2, 3, 4, 5 vertices arranged...}\label{fig:graphtheory-dor1-tikz25}% fig-num-auto

\end{minipage}
%
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz26.png}
\end{minipage}
%
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz27.png}
\end{minipage}
%
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz28.png}
\end{minipage}\\
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{figs/graphtheory-dor1-tikz29.png}\\
\vspace{1cm}
...
\begin{center}
\includegraphics[width=0.39in]{figs/graphtheory-dor1-tikz30.png}
...
\begin{center}
\includegraphics[width=1.56in]{figs/graphtheory-dor1-tikz31.png}
\vspace{1cm}
...
%
\begin{minipage}{.5\textwidth}
\includegraphics[width=2.86in]{figs/graphtheory-dor1-tikz32.png}\par\captionof{figure}{Five-vertex graph with cities A, B, C, D, E as black dots, fully connected with dollar-cost edge...}\label{fig:graphtheory-dor1-tikz32}% fig-num-auto
...
\begin{minipage}{0.5\textwidth}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz33.png}
}\par\captionof{figure}{A spanning subgraph of the Oregon cities graph.}\label{fig:graphtheory-dor1-tikz33}% fig-num-auto
...
\vspace{1in}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz34.png}
}\par\captionof{figure}{Another subgraph of the Oregon cities graph.}\label{fig:graphtheory-dor1-tikz34}% fig-num-auto
...
\begin{center}
\includegraphics[width=3.90in]{figs/graphtheory-dor1-tikz35.png}\par\captionof{figure}{Undirected weighted graph with six yellow circular vertices A, B, C, E, F, G arranged hexagonally.}\label{fig:graphtheory-dor1-tikz35}% fig-num-auto
...
%
\begin{minipage}{0.47\textwidth}
\includegraphics[width=2.88in]{figs/graphtheory-dor1-tikz36.png}
...
%
\begin{minipage}{.5\textwidth}
\includegraphics[width=2.86in]{figs/graphtheory-dor1-tikz37.png}
\end{minipage}
...
\includegraphics[width=3.23in]{figs/graphtheory-dor1-tikz38.png}
...
\includegraphics[width=3.67in]{figs/graphtheory-dor1-tikz39.png}\par\captionof{figure}{Boxed figure for Prim's algorithm: 7-vertex graph with vertices a, b, c, d, e, f, g as red circles.}\label{fig:graphtheory-dor1-tikz39}% fig-num-auto
...
\altincludegraphics{graph-theory-graphics/GraphExercise1.png}{Exercise diagram: a stylized neighborhood shown as six rectangular blocks in two rows of three. Black squares on the inside borders of each block mark houses; students draw edges along the streets the carrier walks to reach every house.}\\\par\captionof{figure}{Exercise diagram: a stylized neighborhood shown as six rectangular blocks in two rows of three.}\label{fig:GraphExercise1}% fig-num-auto
...
\altincludegraphics{graph-theory-graphics/GraphExercise2.png}{Exercise map of a fictional town: a teal river divides the area into several land masses, with seven black bars marking bridges. Students convert the map to a graph to test for an Eulerian path crossing each bridge once.}\\\par\captionof{figure}{Exercise map of a fictional town: a teal river divides the area into several land masses, with...}\label{fig:GraphExercise2}% fig-num-auto
...
\hline
\end{tabular}
\par\captionof{table}{Approximate driving times in minutes between five Dallas-area cities.}\label{tab:graphtheory-dor1-tab02}% tab-num-auto
...
\hline
\end{tabular}
\par\captionof{table}{One-way airfares between five cities.}\label{tab:graphtheory-dor1-tab03}% tab-num-auto

\end{center}

\item	Find the degree of each vertex in the graph below.\\

\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz40.png}\par\captionof{figure}{Seven-vertex weighted graph for the shortest-path exercise.}\label{fig:graphtheory-dor1-tikz40}% fig-num-auto


\item	Find the degree of each vertex in the graph below.\\

\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz41.png}\par\captionof{figure}{Airfare table giving one-way dollar fares between Seattle, Honolulu, London, Moscow, and Cairo (e.g.}\label{fig:graphtheory-dor1-tikz41}% fig-num-auto
...
\hline
&&\\
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz42.png}
&
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz43.png}
&
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz44.png}\\
&&\\
\hline
\end{tabular}\\\par\captionof{figure}{Three five-vertex graphs for the connectedness exercise.}\label{fig:graphtheory-dor1-connected-a}% fig-num-auto
...
\hline
&&\\
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz45.png}
&
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz46.png}
&
\includegraphics[width=0.99in]{figs/graphtheory-dor1-tikz47.png}\\
&&\\
\hline
\end{tabular}\\\par\captionof{figure}{Three more graphs for the connectedness exercise.}\label{fig:graphtheory-dor1-connected-b}% fig-num-auto
...
\includegraphics[width=3.99in]{figs/graphtheory-dor1-tikz48.png}\par\captionof{figure}{European rail network with travel times between cities.}\label{fig:graphtheory-dor1-tikz48}% fig-num-auto
...
\includegraphics[width=2.86in]{figs/graphtheory-dor1-tikz49.png}\\\par\captionof{figure}{Weighted graph on five labelled vertices A, B, C, D, E in a pentagonal layout, fully connected by...}\label{fig:graphtheory-dor1-tikz49}% fig-num-auto
...
\includegraphics[width=4.97in]{figs/graphtheory-dor1-tikz50.png}\par\captionof{figure}{Virginia cities road network with distances.}\label{fig:graphtheory-dor1-tikz50}% fig-num-auto
...
\hline
\end{tabular}
\par\captionof{table}{Friendship table: an X marks pairs of people who are friends.}\label{tab:graphtheory-dor1-tab04}% tab-num-auto
...
\begin{center}
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz51.png}
}
\end{center}
\end{minipage}
%
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz52.png}
}
\end{center}
\end{minipage}
\end{example}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz53.png}
}
\end{center}
\end{minipage}
%
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.09in]{figs/graphtheory-dor1-tikz54.png}
}
\end{center}
\end{minipage}
\end{example}
...
\scalebox{.8}{
\includegraphics[width=2.76in]{figs/graphtheory-dor1-tikz55.png}
}
\end{example}
...
\begin{minipage}{0.5\textwidth}
\includegraphics[width=2.36in]{figs/graphtheory-dor1-tikz56.png}     
\end{minipage}
%
\begin{minipage}{0.5\textwidth}
\includegraphics[width=2.36in]{figs/graphtheory-dor1-tikz57.png}     
\end{minipage}
\end{example}
...
\includegraphics[width=2.36in]{figs/graphtheory-dor1-tikz58.png}
...
\hline
\includegraphics[width=1.69in]{figs/graphtheory-dor1-tikz59.png}
&
\includegraphics[width=1.69in]{figs/graphtheory-dor1-tikz60.png}
&
\includegraphics[width=1.69in]{figs/graphtheory-dor1-tikz61.png}\\
...
\includegraphics[width=3.67in]{figs/graphtheory-dor1-tikz62.png}
\end{ex}
...
\includegraphics[width=1.38in]{figs/graphtheory-dor1-tikz63.png}
&
\includegraphics[width=1.38in]{figs/graphtheory-dor1-tikz64.png}\\
&\\
\includegraphics[width=1.42in]{figs/graphtheory-dor1-tikz65.png}
&
\includegraphics[width=1.38in]{figs/graphtheory-dor1-tikz66.png}\\
\end{tabular}
\end{center}
\end{example}
...
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz67.png}
}
\end{ex}
...
\begin{center}
\includegraphics[width=1.61in]{figs/graphtheory-dor1-tikz68.png}
\end{center}
\end{example}
...
\scalebox{.8}{
\includegraphics[width=2.76in]{figs/graphtheory-dor1-tikz69.png}
}
...
%
\begin{minipage}{0.5\textwidth}
\includegraphics[width=3.23in]{figs/graphtheory-dor1-tikz70.png}
\end{minipage}
...
\begin{center}
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz71.png}
\end{center}
...
\hline
\end{tabular}
\par\captionof{table}{Possible Hamiltonian circuits of the graph and their total weights.}\label{tab:graphtheory-dor1-tab05}% tab-num-auto
...
\noindent \scalebox{.5}{
\includegraphics[width=\linewidth]{figs/graphtheory-dor1-tikz72.png}
}
...
\hline
\end{tabular}
\par\captionof{table}{Growth in the number of unique Hamiltonian circuits as the number of cities increases.}\label{tab:graphtheory-dor1-tab06}% tab-num-auto
...
\begin{center}
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz73.png}
}
\end{center}
...
%
\begin{minipage}{0.5\textwidth}
\includegraphics[width=3.23in]{figs/graphtheory-dor1-tikz74.png}
\end{minipage}
...
\begin{center}
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz75.png}
}
\end{center}
...
\hline
\end{tabular}
\par\captionof{table}{Distances between the six computers in the office network.}\label{tab:graphtheory-dor1-tab07}% tab-num-auto
...
\begin{center}
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz76.png}
}
\end{center}
\end{minipage}
%
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz77.png}
}
\end{center}
\end{minipage}
...
\begin{center}
\scalebox{.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz78.png}
}
\end{center}
\end{minipage}
%
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz79.png}
}
\end{center}
\end{minipage}
%
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz80.png}
}
\end{center}
\end{minipage}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=2.08in]{figs/graphtheory-dor1-tikz81.png}
}
\end{center}
...
\vspace{0.5in}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz82.png}
}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz83.png}
}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz84.png}
}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
\scalebox{0.7}{
\includegraphics[width=3.80in]{figs/graphtheory-dor1-tikz85.png}
}
\end{minipage}
...
\includegraphics[width=2.88in]{figs/graphtheory-dor1-tikz86.png}
\end{ex}
