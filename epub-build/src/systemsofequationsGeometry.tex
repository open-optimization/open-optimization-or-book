...
\includegraphics[width=\linewidth]{figs/systemsofequationsGeometry-tikz01.png}\par\captionof{figure}{Three side-by-side 2D plots showing how two lines can intersect: 'One Solution' (crossing at a...}\label{fig:systemsofequationsGeometry-tikz01}% fig-num-auto
...
\begin{example}{A Graphical Solution}\label{exa:graphicalsoln}
...
\begin{center}
\includegraphics[width=2.88in]{figs/systemsofequationsGeometry-tikz02.png}\par\captionof{figure}{Two-dimensional plot of the system x+y=3 and y-x=5: a green line and a blue line crossing at the...}\label{fig:systemsofequationsGeometry-tikz02}% fig-num-auto
...
\begin{center}
\includegraphics[width=3.21in]{figs/systemsofequationsGeometry-tikz03.png}\par\captionof{figure}{Two side-by-side two-dimensional plots showing three lines in the plane: on the left, three lines...}\label{fig:systemsofequationsGeometry-tikz03}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{Two planes intersecting in a line.}\label{fig:planes-intersect-line}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{Three planes with no common point of intersection.}\label{fig:planes-no-common-point}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{Three planes intersecting in a single point.}\label{fig:planes-single-point}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{A third plane through the line of intersection of two planes.}\label{fig:planes-new-plane}% fig-num-auto
