...
\includegraphics[width=4.34in]{figs/simplex-basis-driven-tikz08.png}\par\captionof{figure}{The feasible region with the basis and objective value at every vertex; the simplex path leads to...}\label{fig:simplex-basis-driven-tikz08}% fig-num-auto
...
\begin{center}
\altincludegraphics[scale = 0.5]{Figures/unbounded-desmos-simplex}{Desmos plot of the feasible region defined by x1-x2<=1, 2x1-x2<=3, x1,x2>=0: an unbounded region extending to the right in the first quadrant, illustrating the unbounded LP example.}\par\captionof{figure}{Desmos plot of the feasible region defined by x1-x2<=1, 2x1-x2<=3, x1,x2>=0: an unbounded region...}\label{fig:unbounded-desmos-simplex}% fig-num-auto
...
\begin{center}
\altincludegraphics[width=0.6\textwidth]{Figures/desmos-graph-slacks}{Desmos graph of a 2-variable LP feasible region with vertices labeled A, B, C, D used to identify basic and nonbasic variables and to trace pivot moves between adjacent basic feasible solutions.}\par\captionof{figure}{Desmos graph of a 2-variable LP feasible region with vertices labeled A, B, C, D used to identify...}\label{fig:desmos-graph-slacks}% fig-num-auto
