...
\begin{definition}{Dot Product}\label{def:dotproductdefn}
...
\begin{example}{Compute a Dot Product}\label{exa:dotproduct}
...
\begin{proposition}{Properties of the Dot Product}\label{prop:propertiesdotproduct}
...
\begin{example}{Length of a Vector}\label{exa:dotproductlength}
Find the length of
\begin{equation*}
\vect{u}
=
...
\begin{theorem}{Cauchy Schwarz Inequality}\label{thm:cauchyschwarzinequality}
...
\begin{theorem}{Triangle Inequality}\label{thm:triangleinequalitydotproduct}
