...
\begin{center}
\includegraphics[width=3.04in]{figs/equations-and-lines-new-tikz01.png}\par\captionof{figure}{Two-dimensional plot of the line y = 3x + 2 on x-y axes with a gridded background.}\label{fig:equations-and-lines-new-tikz01}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.93in]{figs/equations-and-lines-new-tikz02.png}\par\captionof{figure}{Two-dimensional plot of the line 2x + y = 4 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz02}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.90in]{figs/equations-and-lines-new-tikz03.png}\par\captionof{figure}{A line through the intercepts (0,-2) and (3,0).}\label{fig:equations-and-lines-new-tikz03}% fig-num-auto
...
Plot these points and draw the line.
\begin{center}
\includegraphics[width=2.90in]{figs/equations-and-lines-new-tikz04.png}\par\captionof{figure}{A line through the points (3,1), (5,2), and (7,3).}\label{fig:equations-and-lines-new-tikz04}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.90in]{figs/equations-and-lines-new-tikz05.png}\par\captionof{figure}{Two-dimensional plot of the horizontal line y = 3 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz05}% fig-num-auto

\includegraphics[width=3.17in]{figs/equations-and-lines-new-tikz06.png}\par\captionof{figure}{Two-dimensional plot of the vertical line x = -2 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz06}% fig-num-auto
...
\begin{center}
\includegraphics[width=3.17in]{figs/equations-and-lines-new-tikz07.png}\par\captionof{figure}{Two-dimensional plot illustrating the slope of the line through (-2,3) and (4,-1) on x-y axes.}\label{fig:equations-and-lines-new-tikz07}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.90in]{figs/equations-and-lines-new-tikz08.png}\par\captionof{figure}{Two-dimensional plot of the line through (1,2) with slope -3/4 on gridded x-y axes.}\label{fig:equations-and-lines-new-tikz08}% fig-num-auto
...
\begin{center}
\includegraphics[width=\linewidth]{figs/equations-and-lines-new-tikz09.png}\par\captionof{figure}{Two-dimensional plot of an equilibrium point.}\label{fig:equations-and-lines-new-tikz09}% fig-num-auto
...
Break-even at $(6,30)$.
\begin{center}
\includegraphics[width=5.06in]{figs/equations-and-lines-new-tikz10.png}\par\captionof{figure}{Two-dimensional plot of a break-even point.}\label{fig:equations-and-lines-new-tikz10}% fig-num-auto
