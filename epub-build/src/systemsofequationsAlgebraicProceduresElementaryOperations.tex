...
\begin{example}{Verifying an Ordered Pair is a Solution}\label{exa:verifyingorderedpairsolution}
...
\begin{definition}{Elementary Operations}\label{def:elementaryoperations}
...
\begin{example}{Effects of an Elementary Operation}\label{exa:effectsofelementaryoperation}
...
\begin{theorem}{Elementary Operations and Solutions}\label{thm:elementaryoperationsandsolns}
...
\end{equation*}
This gave us the second system in Example \ref{example:effectsofelementaryoperation}, given by 
\begin{equation*}
\begin{array}{c}
E_{1} = b_{1} \\
E_{2} + \left( -2 \right) E_{1} = b_{2} + \left( -2 \right) b_{1}
...
\begin{example}{ Solving a System of Equations with Elementary Operations}\label{exa:solvingasystemwithelementaryops}
