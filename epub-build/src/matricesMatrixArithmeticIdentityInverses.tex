...
\begin{lemma}{Multiplication by the Identity Matrix}\label{lem:multbyidentity}
...
\begin{definition}{The Inverse of a Matrix}\label{def:invertiblematrix}
...
\begin{theorem}{Uniqueness of Inverse}\label{thm:uniqueinverse}
...
\begin{example}{Verifying the Inverse of a Matrix}\label{exa:verifyinginverse}
Let $A=\leftB
\begin{array}{rr}
1 & 1 \\
1 & 2
...
\begin{example}{A Nonzero Matrix With No Inverse}\label{exa:noninvertiblematrix}
Let $A=\leftB
\begin{array}{rr}
1 & 1 \\
1 & 1
