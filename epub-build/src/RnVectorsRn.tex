...
\begin{center}
\includegraphics[width=3.45in]{figs/RnVectorsRn-tikz01.png}\par\captionof{figure}{Two-dimensional plot of the xy-plane showing two points P = (2,1) and Q = (-3,4) marked as red...}\label{fig:RnVectorsRn-tikz01}% fig-num-auto
...
\begin{definition}{The Position Vector}\label{def:positionvector}
...
\begin{center}
\includegraphics[width=2.48in]{figs/RnVectorsRn-tikz02.png}\par\captionof{figure}{Three-dimensional diagram of the position vector 0P: a thick blue arrow from the origin along the...}\label{fig:RnVectorsRn-tikz02}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.67in]{figs/RnVectorsRn-tikz03.png}\par\captionof{figure}{Three-dimensional diagram with two parallel blue arrows of equal length and direction: the position...}\label{fig:RnVectorsRn-tikz03}% fig-num-auto
...
\begin{definition}{Vectors in $\mathbb{R}^n$}\label{def:vectorsRn}
