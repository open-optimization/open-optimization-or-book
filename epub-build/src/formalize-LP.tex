...
\begin{center}
\includegraphics[width=4.54in]{figs/formalize-LP-tikz10.png}
\end{center}
...
\begin{center}
\includegraphics[width=3.19in]{figs/formalize-LP-tikz11.png}
\end{center}
...
\begin{center}  \includegraphics[width=3.65in]{figs/formalize-LP-tikz12.png} \end{center} 
\end{minipage}
