...
\begin{definition}{Scalar Multiplication of Vectors in $\mathbb{R}^n$}\label{def:vectorscalarmultiplication}
...
\begin{theorem}{Properties of Scalar Multiplication}\label{thm:vectorscalarmult}
