...
\begin{example}{The Transpose of a Matrix}\label{exa:transposematrix}
...
\begin{lemma}{Properties of the Transpose of a Matrix}\label{lem:transposeproperties}
...
\begin{example}{Symmetric Matrices}\label{exa:symmetricmatrix}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrr}
...
\begin{example}{A Skew Symmetric Matrix}\label{exa:skewsymmetricmatrix}
Let
\begin{equation*}
A=\leftB
\begin{array}{rrr}
