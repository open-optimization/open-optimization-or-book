...
\begin{center}
\includegraphics[width=4.06in]{figs/RnVectorsScalarMultMeaning-tikz01.png}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsScalarMultMeaning-tikz01}% fig-num-auto
...
\begin{center}
\includegraphics[width=\linewidth]{figs/RnVectorsScalarMultMeaning-tikz02.png}\par\captionof{figure}{Two-dimensional diagram showing scalar multiples of two vectors: blue vector u and its negative -u...}\label{fig:RnVectorsScalarMultMeaning-tikz02}% fig-num-auto
...
\begin{center}
\includegraphics[width=4.06in]{figs/RnVectorsScalarMultMeaning-tikz03.png}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsScalarMultMeaning-tikz03}% fig-num-auto
...
\begin{center}
\includegraphics[width=3.27in]{figs/RnVectorsScalarMultMeaning-tikz04.png}\par\captionof{figure}{Two-dimensional vector diagram of the linear combination u + 2v: blue vector u from the origin, red...}\label{fig:RnVectorsScalarMultMeaning-tikz04}% fig-num-auto

\end{center}
\begin{center}
\includegraphics[width=1.86in]{figs/RnVectorsScalarMultMeaning-tikz05.png}\par\captionof{figure}{Two-dimensional vector diagram of the linear combination u - 1/2 v: blue u from the origin, the...}\label{fig:RnVectorsScalarMultMeaning-tikz05}% fig-num-auto
