...
\emph{Do the exercises.} Each chapter ends with a graded exercise section: \emph{Warm-ups} drill one skill and name the worked example they mirror, \emph{Core problems} are full modeling and computation problems, \emph{Concepts and connections} ask you to explain why things work, and \emph{Challenge problems} stretch beyond the chapter. Difficulty is marked with stars ($\star$ to $\star\star\star$), and each exercise ends with a small gray tag pointing to the section or example to review if you get stuck. Selected solutions appear at the end of each exercise section; try the problem before reading them.
