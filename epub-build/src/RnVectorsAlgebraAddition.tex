...
\begin{definition}{Addition of Vectors in $\mathbb{R}^n$}\label{def:vectoraddition}
...
\begin{theorem}{Properties of Vector Addition}\label{thm:propertiesvectoraddition}
