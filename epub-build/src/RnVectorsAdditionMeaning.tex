...
\begin{definition}{Geometry of Vector Addition}\label{def:geometryofvectoraddition}
...
\begin{center}
\includegraphics[width=1.70in]{figs/RnVectorsAdditionMeaning-tikz01.png}\par\captionof{figure}{Two-dimensional vector diagram illustrating the tip-to-tail rule for vector addition: arrow u along...}\label{fig:RnVectorsAdditionMeaning-tikz01}% fig-num-auto
...
\end{picture}}
\end{picture}\par\captionof{figure}{Vector addition in three dimensions: u + v as the diagonal of the parallelepiped.}\label{fig:vector-addition-3d}% fig-num-auto
...
\begin{example}{Graphing Vector Addition}\label{exa:graphingvectoraddition}
Consider the following picture of vectors $\vect{u}$ and $\vect{v}$.

\begin{center}
\includegraphics[width=4.06in]{figs/RnVectorsAdditionMeaning-tikz02.png}\par\captionof{figure}{Two-dimensional sketch of vectors u (blue, up and right) and v (red, down and right) drawn as...}\label{fig:RnVectorsAdditionMeaning-tikz02}% fig-num-auto
...
\begin{center}
\includegraphics[width=2.49in]{figs/RnVectorsAdditionMeaning-tikz03.png}\par\captionof{figure}{Two-dimensional vector diagram of u+v drawn tip-to-tail: blue u from the origin to the upper right...}\label{fig:RnVectorsAdditionMeaning-tikz03}% fig-num-auto
...
\begin{center}
\includegraphics[width=1.71in]{figs/RnVectorsAdditionMeaning-tikz04.png}\par\captionof{figure}{Two-dimensional vector diagram of u-v: blue u from the origin, red -v starting at the tip of u and...}\label{fig:RnVectorsAdditionMeaning-tikz04}% fig-num-auto
