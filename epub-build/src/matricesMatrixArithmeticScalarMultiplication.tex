...
\begin{example}{Effect of Multiplication by a Scalar}\label{exa:effectofscalarmult}
...
\begin{proposition}{Properties of Scalar Multiplication}\label{prop:propertiesscalarmult}
