...
\begin{example}{Finding the Inverse}\label{exa:findinginverse}
Let $A=\leftB
\begin{array}{rrr}
1 & 2 & 2 \\
1 & 0 & 2 \\
...
\begin{example}{A Matrix Which Has No Inverse}\label{exa:matrixnoinverse}
Let $A=\leftB
\begin{array}{rrr}
1 & 2 & 2 \\
1 & 0 & 2 \\
...
\begin{example}{Using the Inverse to Solve a System of Equations}\label{exa:inversetosolvesystem}
...
%
\begin{theorem}{Inverses of Transposes and Products}\label{thm:inversetransposeprod}
...
%
\begin{theorem}{Properties of the Inverse}\label{thm:inverseproperties}
