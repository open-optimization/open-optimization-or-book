...
\begin{center}
\includegraphics[width=0.71in]{figs/RnVectorsDotProductSignificance-tikz01.png}\par\captionof{figure}{Two-dimensional sketch of two vectors emanating from a common origin: a blue vector v pointing up...}\label{fig:RnVectorsDotProductSignificance-tikz01}% fig-num-auto

\end{center}

\begin{proposition}{The Dot Product and the Included Angle}\label{prop:dotproductangle}
...
\begin{example}{Find the Angle Between Two Vectors}\label{exa:angletwovectors}
...
\begin{example}{Find the Angle Between Two Lines}\label{exa:anglebetweentwolines}
...
\begin{example}{Using Geometric Description to Find a Dot Product}\label{exa:geometricdotproduct}
...
\begin{proposition}{Perpendicular Vectors}\label{prop:perpvectors}
...
\begin{example}{Determine if Two Vectors are Perpendicular}\label{exa:perpendicularvectors}
