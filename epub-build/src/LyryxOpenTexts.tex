...
\vspace{0pt}
\altincludegraphics[scale=0.15]{component-book}{Lyryx 'Open Text' component icon: a stylized open book.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{component-assess}{Lyryx 'Online Assessment' component icon: a checklist or graded form glyph.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{component-support}{Lyryx 'Support' component icon: a headset glyph representing customer support.}
&
\vspace{0pt}
...
\begin{tabu}{X[1,c,m] X[2,l,m]}
\vspace{0pt}
\altincludegraphics[scale=0.15]{component-supplement}{Lyryx 'Instructor Supplements' component icon: stacked documents or resource pages glyph.}
&
\vspace{0pt}
