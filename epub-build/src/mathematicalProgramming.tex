...
\begin{figure}[h]
\centering
\includegraphics[width=3.70in]{figs/mathematicalProgramming-tikz01.png}
...
\centering
\includegraphics[width=1.59in]{figs/mathematicalProgramming-tikz02.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=3.48in]{figs/mathematicalProgramming-tikz03.png}
...
\paragraph{IP as NLP}
Interestingly, quadratic constraints can be used to create a feasible region with discrete solutions.  For example 
$$
x(1-x) = 0
$$
...
\begin{figure}[h]
\centering
\includegraphics[width=2.44in]{figs/mathematicalProgramming-tikz04.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=2.37in]{figs/mathematicalProgramming-tikz05.png}
