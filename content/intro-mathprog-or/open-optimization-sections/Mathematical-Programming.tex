...
\includefigurestatic[][width = 1\linewidth]{problem-class-diagram}
...
\refincludefigurestatic[Linear programming constraints and objective.][scale = 0.2]{wiki/File/linear-programming.png}
...
\refincludefigurestatic[Comparing the LP relaxation to the IP solutions.][scale = 0.3]{wiki/File/integer-programming.png}
