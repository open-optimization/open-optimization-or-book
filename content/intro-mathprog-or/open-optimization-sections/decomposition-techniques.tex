...
\begin{definition}[Lagrangean relaxation] Given $u\in\R^{m_1}_+$, the Lagrangean relaxation is the following MIP
...
\begin{definition}[Lagrangean dual] The Lagrangean dual is the following optimization  problem
...
\begin{definition}[Master problem]
...
\begin{definition}[The pricing subproblem] Let $\bar y\in\R^m$ be an optimal solution to the dual of (MLP). Consider the following optimization problem
...
\begin{definition}[Dantzig-Wolf reformulation] The following MIP is the Dantzig-Wolf reformulation of (2)
\begin{align*}
...
\begin{definition}[Extended formulation] An extended formulation for $P$ is a polyhedron 
...
\begin{definition}[Extension complexity] The extension complexity of $P$ is the minimum $m$ such that there exists an extended formulation $Q\subseteq \R^n\times \R^m$ of $P$.
\end{definition}
