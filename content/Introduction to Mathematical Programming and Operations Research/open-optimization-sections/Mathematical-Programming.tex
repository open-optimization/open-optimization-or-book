...
\begin{figure}
\begin{center}
\includegraphics[scale = 0.3]{linear-programming-wiki}\footnotemark
\end{center}
\caption{Linear programming constraints and objective.}
\end{figure}
\footnotetext{\url{https://en.wikipedia.org/wiki/Linear_programming}}
...
\begin{figure}
\begin{center}
\includegraphics[scale = 0.5]{IP-with-LP-relaxation}\footnotemark
\label{fig:IPversusLP}
\caption{Comparing the LP relaxation to the IP solutions.}
\end{center}
\end{figure}
\footnotetext{Figure from \url{https://en.wikipedia.org/wiki/Integer_programming}.}
