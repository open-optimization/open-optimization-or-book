...
\end{center}
\footnotetext{This table was taken from notes by Laurent Lessard.}
...
A \emph{tour} is a cycle that visits all the nodes in $N$ exactly once and returns back to the starting node.
...
\end{center}
\footnotetext{This figure was taken from notes by Laurent Lessard.}
...
\includegraphics[scale = 0.5]{CompleteGraphCycles5-850}\footnotemark
\footnotetext{\url{http://mathworld.wolfram.com/CompleteGraph.html}}
