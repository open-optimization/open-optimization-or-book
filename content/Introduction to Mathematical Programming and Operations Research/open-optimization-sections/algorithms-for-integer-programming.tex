...
%This is the graph
\includegraphics[scale = 0.3]{integer-lp-relaxation}
\end{minipage}
\end{example}
...
\includegraphics[scale = 0.9, page = 1, trim= 1cm 0 0 4cm, clip=true]{winston-branch-and-bound}

\includegraphics[scale = 0.9, page = 2, trim= 1cm 0 0 4cm, clip=true]{winston-branch-and-bound}
\includegraphics[scale = 0.9, page = 3, trim= 1cm 0 0 4cm, clip=true]{winston-branch-and-bound}
\includegraphics[scale = 0.9, page = 4, trim= 1cm 0 0 0, clip=true]{winston-branch-and-bound}
\includegraphics[scale = 0.9, page = 5, trim= 1cm 0 0 0, clip=true]{winston-branch-and-bound}
...
\begin{center}
\includegraphics[scale = 0.5]{branch-and-bound-tree-from-textbook}
\end{center}
...
\input{../figures/branch-and-bound-tree-max-knapsack.tex}
...
\textbf{Model} & \textbf{LP Solution} \\\hline \hline
 \includegraphics[scale = 0.5]{cutting-plane-1-equation} &
\includegraphics[scale = 0.5]{cutting-plane-1-picture}\\
\includegraphics[scale = 0.5]{cutting-plane-2-equation} &
\includegraphics[scale = 0.5]{cutting-plane-2-picture}\\
\includegraphics[scale = 0.5]{cutting-plane-3-equation} &
...
\includegraphics[scale = 0.85, page = 1, trim= 3cm 2cm 1cm 6cm, clip=true]{advmathprog-leo-gomory-cuts.pdf}\footnote{Material from notes by Leo Liberti. \url{https://www.lix.polytechnique.fr/~liberti/teaching/ieor/advmathprog.pdf}}
\newpage

\includegraphics[scale = 0.9, page = 2, trim= 1cm 0 0 4cm, clip=true]{advmathprog-leo-gomory-cuts.pdf}
\includegraphics[scale = 0.9, page = 3, trim= 1cm 0 0 4cm, clip=true]{advmathprog-leo-gomory-cuts.pdf}
\includegraphics[scale = 0.9, page = 4, trim= 1cm 0 0 4cm, clip=true]{advmathprog-leo-gomory-cuts.pdf}
\includegraphics[scale = 0.9, page = 5, trim= 1cm 16cm 0 4cm, clip=true]{advmathprog-leo-gomory-cuts.pdf}
\subsection{Fun with cutting planes}
The Cutting Plane Game:\\
\url{http://www.columbia.edu/~gm2543/cpgame.html}

\includegraphics[scale = 0.5]{the-cutting-plane-game}
