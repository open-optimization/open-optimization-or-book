...
\includegraphics[scale = 0.5]{convex-hull}\footnotemark \ \ 
%\includegraphics[scale = 0.5]{convex-hull-cow}\footnotemark
\end{center}
\end{figure}
\footnotetext{\url{https://www.boost.org/doc/libs/1_63_0/libs/geometry/doc/html/geometry/reference/algorithms/convex_hull.html}}
%\footnotetext{\url{https://www.wolfram.com/mathematica/new-in-10/data-and-mesh-regions/convex-hulls.html}}
...
%\footnotetext{Code for image borrowed form \url{https://tex.stackexchange.com/questions/302589/alignment-of-tikz-pictures-in-subfigures/302604#302604}}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale = 0.12, trim = {0 0 0 10cm}, clip ]{first-order-convexity}\footnotemark
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
%\includegraphics[scale = 0.1]{linear-regression}\footnotemark
\includegraphics[scale = 1]{LinearRegression.pdf}\footnotemark
\end{center}
\end{figure}
\footnotetext{\url{https://latexdraw.com/linear-regression-in-latex-using-tikz/}}
%\footnotetext{\url{https://en.wikipedia.org/wiki/Linear_regression}}
...
\includegraphics[scale = 0.1]{youtube-linear-regression}
...
\includegraphics[scale = 0.5]{SVM-R2}



\includegraphics[scale = 0.5]{SVM-R3}\footnotemark

\footnotetext{\url{https://zenodo.org/record/2564435}}%#.XcmSHpJKhTY}}

\url{https://www.youtube.com/watch?time_continue=6&v=N1vOgolbjSc}

\includegraphics[scale = 0.1]{youtube-svm}
...
\begin{example}
\begin{center}
\includegraphics[scale = 0.3]{svm-nonlinear} \ \ \includegraphics[scale = 0.3]{svm-nonlinear-training}
\end{center}
...
\includegraphics[scale = 0.2]{classification-comparison.png}\footnotemark
\footnotetext{From Scikitlearn webpage \url{https://scikit-learn.org/stable/auto_examples/classification/plot_classifier_comparison.html}}


\subsection{Machine Learning}

\url{https://www.youtube.com/watch?v=bwZ3Qiuj3i8&list=PL9ooVrP1hQOHUfd-g8GUpKI3hHOwM_9Dn&index=13}
\includegraphics[scale = 0.1]{youtube-ML-scikitlearn}
...
\begin{center}
\includegraphics[scale = 0.3]{circles-figure}
\end{center}
